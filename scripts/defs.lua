...
MONSTER_TOUGHNESS  = { weak=0.1, medium=0.5, tough=1.2 }
MONSTER_MAX_TIME   = { weak=12,  medium=16,  tough=24 }
MONSTER_MAX_DAMAGE = { weak=100, medium=200, tough=300, }
MONSTER_LOW_DAMAGE = { weak=0.1, medium=0.4, tough=3, }
