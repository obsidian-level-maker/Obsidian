...
ROOM_EXITS_2x1 =
{
  { prob=30, exits={ 1,1,4, 2,1,6 }},
  { prob=15, exits={ 1,1,4, 2,1,8 }},
  { prob=50, exits={ 1,1,2, 2,1,8 }},
  { prob= 5, exits={ 1,1,2, 2,1,2 }},

  { prob=70, exits={ 1,1,4, 2,1,2, 2,1,8 }},
  { prob=50, exits={ 1,1,4, 2,1,2, 2,1,8, 2,1,6 }},
  { prob=30, exits={ 1,1,2, 1,1,8, 2,1,2, 2,1,8 }},
  { prob=20, exits={ 1,1,2, 1,1,4, 2,1,6, 2,1,8 }},
  { prob=30, exits={ 1,1,2, 1,1,4, 2,1,2, 2,1,8 }},
}
...
ROOM_EXITS_2x2 =
{
  ...
  { prob=40, exits={ 1,1,4, 1,2,4, 2,1,6, 2,2,6 }},
  { prob=60, exits={ 1,1,4, 1,2,8, 2,2,8, 2,1,6 }},
}

ROOM_EXITS_3x1 =
{
  { prob=10, exits={ 1,1,4, 3,1,6 }},
  { prob= 7, exits={ 1,1,4, 3,1,8 }},
  { prob=14, exits={ 1,1,2, 3,1,8 }},
  { prob= 7, exits={ 1,1,2, 3,1,2 }},

  { prob=20, exits={ 1,1,4, 2,1,8, 3,1,8 }},
  { prob=40, exits={ 1,1,4, 3,1,2, 3,1,8 }},
  { prob=70, exits={ 1,1,8, 2,1,2, 3,1,8 }},
  { prob=70, exits={ 1,1,4, 2,1,2, 3,1,6 }},

  { prob=90, exits={ 1,1,4, 2,1,2, 2,1,8, 3,1,6 }},
  { prob=30, exits={ 1,1,4, 1,1,8, 3,1,8, 3,1,6 }},
  { prob=30, exits={ 1,1,4, 1,1,8, 3,1,2, 3,1,6 }},
  { prob=30, exits={ 1,1,2, 1,1,8, 3,1,8, 3,1,2 }},
...
ROOM_EXITS_3x3 =
{
  ...
  { prob= 2, exits={ 2,1,2, 1,3,8, 3,3,8 }},
  { prob= 2, exits={ 2,1,2, 1,3,4, 3,3,6 }},

  { prob=99, exits={ 2,1,2, 1,2,4, 3,2,6, 2,3,8 }},
...
ROOM_EXITS_4x2 =
{
  ...
  { prob=20, exits={ 1,1,2, 2,2,8, 3,2,8, 4,1,2 }},
  { prob=20, exits={ 1,1,4, 2,2,8, 3,2,8, 4,1,6 }},
