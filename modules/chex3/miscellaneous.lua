...
MISC_STUFF_CHEX3.LIGHT_CHOICES =
{
  "-3",   _("Pitch-black"),
  "-2",   _("Gloomy"),
  "-1",   _("Darker"),
...
MISC_STUFF_CHEX3.LIVEMAP_CHOICES =
{
...
MISC_STUFF_CHEX3.SINK_STYLE_CHOICES =
{
  "themed", _("Per Theme"),
  "curved", _("Curved"),
  "sharp", _("Sharp"),
...
MISC_STUFF_CHEX3.HEIGHT_CHOICES =
{
...
MISC_STUFF_CHEX3.WINDOW_BLOCKING_CHOICES =
{
...
MISC_STUFF_CHEX3.RAIL_BLOCKING_CHOICES =
{
  "never",       _("Never"),
...
MISC_STUFF_CHEX3.LIQUID_SINK_OPTIONS =
{
  "yes",          _("Yes"),
...
MISC_STUFF_CHEX3.LINEAR_START_CHOICES =
{
  "100",     _("All"),
...
MISC_STUFF_CHEX3.ROOM_SIZE_MULTIPLIER_CHOICES =
{
  "0.25", _("x0.25"),
  "0.5", _("x0.5"),
  "0.75", _("x0.75"),
...
MISC_STUFF_CHEX3.AREA_COUNT_MULTIPLIER_CHOICES =
{
  "0.15", _("x0.15"),
  "0.5", _("x0.5"),
  "0.75", _("x0.75"),
...
MISC_STUFF_CHEX3.ROOM_SIZE_CONSISTENCY_CHOICES =
{
  "normal", _("Vanilla"),
  "strict", _("Strict"),
  "mixed", _("Mix It Up")
...
function MISC_STUFF_CHEX3.setup(self)
...
function MISC_STUFF_CHEX3.begin_level(self)
  for _,opt in pairs(self.options) do
...
OB_MODULES["misc_chex3"] =
{
  ...
  hooks =
  {
    setup = MISC_STUFF_CHEX3.setup,
    begin_level = MISC_STUFF_CHEX3.begin_level
  },
  ...
  options =
  {
...

    {
      ...
      choices = MISC_STUFF_CHEX3.ROOM_SIZE_MULTIPLIER_CHOICES,
      default = "mixed",
    ...
    },
    {
      ...
      choices = MISC_STUFF_CHEX3.AREA_COUNT_MULTIPLIER_CHOICES,
      default = "mixed",
    ...
    },
    {
      ...
      choices = MISC_STUFF_CHEX3.ROOM_SIZE_CONSISTENCY_CHOICES,
      default = "mixed",
    ...
    { name="big_outdoor_rooms", label=_("Big Outdoors"), choices=STYLE_CHOICES },
    {
      ...
      choices=MISC_STUFF_CHEX3.HEIGHT_CHOICES,
    ...
    { name="windows",     label=_("Windows"),        choices=STYLE_CHOICES },
    {
      ...
      choices=MISC_STUFF_CHEX3.WINDOW_BLOCKING_CHOICES,
    ...
    },
    {
      ...
      choices=MISC_STUFF_CHEX3.RAIL_BLOCKING_CHOICES,
    ...
    { name = "corner_style",
      label=_("Sink Style"),
      choices=MISC_STUFF_CHEX3.SINK_STYLE_CHOICES,
    ...
    },
    {
      ...
      choices=MISC_STUFF_CHEX3.LIQUID_SINK_OPTIONS,
    ...
    { name="brightness_offset",
      ...
      choices=MISC_STUFF_CHEX3.LIGHT_CHOICES,
...
--]]
    {
      ...
      choices=MISC_STUFF_CHEX3.LINEAR_START_CHOICES,
...

    {
      ...
      choices=MISC_STUFF_CHEX3.LIVEMAP_CHOICES,
