...
MISC_STUFF_HACX.LIVEMAP_CHOICES =
{
...
MISC_STUFF_HACX.SINK_STYLE_CHOICES =
{
  "themed", _("Per Theme"),
  "curved", _("Curved"),
  "sharp", _("Sharp"),
...
MISC_STUFF_HACX.HEIGHT_CHOICES =
{
...
MISC_STUFF_HACX.WINDOW_BLOCKING_CHOICES =
{
...
MISC_STUFF_HACX.RAIL_BLOCKING_CHOICES =
{
  "never",       _("Never"),
...
MISC_STUFF_HACX.LIQUID_SINK_OPTIONS =
{
  "yes",          _("Yes"),
...
MISC_STUFF_HACX.LINEAR_START_CHOICES =
{
  "100",     _("All"),
...
function MISC_STUFF_HACX.setup(self)
...
function MISC_STUFF_HACX.begin_level(self)
  for _,opt in pairs(self.options) do
...
OB_MODULES["misc_hacx"] =
{
  ...
  hooks =
  {
    setup = MISC_STUFF_HACX.setup,
    begin_level = MISC_STUFF_HACX.begin_level
  },
  ...
  options =
  {
    ...
    { name="big_outdoor_rooms", label=_("Big Outdoors"), choices=STYLE_CHOICES },
    {
      ...
      choices=MISC_STUFF_HACX.HEIGHT_CHOICES,
    ...
    { name="windows",     label=_("Windows"),        choices=STYLE_CHOICES },
    {
      ...
      choices=MISC_STUFF_HACX.WINDOW_BLOCKING_CHOICES,
    ...
    },
    {
      ...
      choices=MISC_STUFF_HACX.RAIL_BLOCKING_CHOICES,
    ...
    { name = "corner_style",
      label=_("Sink Style"),
      choices=MISC_STUFF_HACX.SINK_STYLE_CHOICES,
    ...
    },
    {
      ...
      choices=MISC_STUFF_HACX.LIQUID_SINK_OPTIONS,
    ...
    { name="brightness_offset",
      ...
      choices=MISC_STUFF_HACX.LIGHT_CHOICES,
...

    {
      ...
      choices=MISC_STUFF_HACX.LINEAR_START_CHOICES,
...

    {
      ...
      choices=MISC_STUFF_HACX.LIVEMAP_CHOICES,
...
-- already done: -- MSSP
--  { name="light_level",  label=_("Lighting"),   choices=MISC_STUFF_HACX.LIGHTINGS },
--  { name="detail_level", label=_("Detail"),     choices=MISC_STUFF_HACX.LIGHTINGS, gap=1 },
