...
MISC_STUFF_HARMONY.LIGHT_CHOICES =
{
  "-3",   _("Pitch-black"),
  "-2",   _("Gloomy"),
  "-1",   _("Darker"),
...
MISC_STUFF_HARMONY.LIVEMAP_CHOICES =
{
...
MISC_STUFF_HARMONY.SINK_STYLE_CHOICES =
{
  "themed", _("Per Theme"),
  "curved", _("Curved"),
  "sharp", _("Sharp"),
...
MISC_STUFF_HARMONY.HEIGHT_CHOICES =
{
...
MISC_STUFF_HARMONY.WINDOW_BLOCKING_CHOICES =
{
...
MISC_STUFF_HARMONY.RAIL_BLOCKING_CHOICES =
{
  "never",       _("Never"),
...
MISC_STUFF_HARMONY.LIQUID_SINK_OPTIONS =
{
  "yes",          _("Yes"),
...
MISC_STUFF_HARMONY.LINEAR_START_CHOICES =
{
  "100",     _("All"),
...
MISC_STUFF_HARMONY.ROOM_SIZE_MULTIPLIER_CHOICES =
{
  "0.25", _("x0.25"),
  "0.5", _("x0.5"),
  "0.75", _("x0.75"),
...
MISC_STUFF_HARMONY.AREA_COUNT_MULTIPLIER_CHOICES =
{
  "0.15", _("x0.15"),
  "0.5", _("x0.5"),
  "0.75", _("x0.75"),
...
MISC_STUFF_HARMONY.ROOM_SIZE_CONSISTENCY_CHOICES =
{
  "normal", _("Vanilla"),
  "strict", _("Strict"),
  "mixed", _("Mix It Up")
...
OB_MODULES["misc_harmony"] =
{
  ...
  hooks =
  {
    setup = MISC_STUFF_HARMONY.setup,
    begin_level = MISC_STUFF_HARMONY.begin_level
  },
  ...
  options =
  {
...

    {
      ...
      choices = MISC_STUFF_HARMONY.ROOM_SIZE_MULTIPLIER_CHOICES,
      default = "mixed",
    ...
    },
    {
      ...
      choices = MISC_STUFF_HARMONY.AREA_COUNT_MULTIPLIER_CHOICES,
      default = "mixed",
    ...
    },
    {
      ...
      choices = MISC_STUFF_HARMONY.ROOM_SIZE_CONSISTENCY_CHOICES,
      default = "mixed",
    ...
    { name="big_outdoor_rooms", label=_("Big Outdoors"), choices=STYLE_CHOICES },
    {
      ...
      choices=MISC_STUFF_HARMONY.HEIGHT_CHOICES,
    ...
    { name="windows",     label=_("Windows"),        choices=STYLE_CHOICES },
    {
      ...
      choices=MISC_STUFF_HARMONY.WINDOW_BLOCKING_CHOICES,
    ...
    },
    {
      ...
      choices=MISC_STUFF_HARMONY.RAIL_BLOCKING_CHOICES,
    ...
    { name = "corner_style",
      label=_("Sink Style"),
      choices=MISC_STUFF_HARMONY.SINK_STYLE_CHOICES,
    ...
    },
    {
      ...
      choices=MISC_STUFF_HARMONY.LIQUID_SINK_OPTIONS,
...
--[[    {
    ...
    
    {
      ...
      choices=MISC_STUFF_HARMONY.LINEAR_START_CHOICES,
...

    {
      ...
      choices=MISC_STUFF_HARMONY.LIVEMAP_CHOICES,
