...
MISC_STUFF_NUKEM.LIGHT_CHOICES =
{
  "-3",   _("Pitch-black"),
  "-2",   _("Gloomy"),
  "-1",   _("Darker"),
...
MISC_STUFF_NUKEM.HEIGHT_CHOICES =
{
...
MISC_STUFF_NUKEM.WINDOW_BLOCKING_CHOICES =
{
...
MISC_STUFF_NUKEM.RAIL_BLOCKING_CHOICES =
{
  "never",       _("Never"),
...
MISC_STUFF_NUKEM.LIQUID_SINK_OPTIONS =
{
  "yes",          _("Yes"),
...
MISC_STUFF_NUKEM.LINEAR_START_CHOICES =
{
  "100",     _("All"),
...
MISC_STUFF_NUKEM.ROOM_SIZE_MULTIPLIER_CHOICES =
{
  "0.25", _("x0.25"),
  "0.5", _("x0.5"),
  "0.75", _("x0.75"),
...
MISC_STUFF_NUKEM.AREA_COUNT_MULTIPLIER_CHOICES =
{
  "0.15", _("x0.15"),
  "0.5", _("x0.5"),
  "0.75", _("x0.75"),
...
MISC_STUFF_NUKEM.ROOM_SIZE_CONSISTENCY_CHOICES =
{
  "normal", _("Vanilla"),
  "strict", _("Strict"),
  "mixed", _("Mix It Up")
...
function MISC_STUFF_NUKEM.setup(self)
...
function MISC_STUFF_NUKEM.begin_level(self)
  for _,opt in pairs(self.options) do
...
OB_MODULES["misc_nukem"] =
{
  ...
  hooks =
  {
    setup = MISC_STUFF_NUKEM.setup,
    begin_level = MISC_STUFF_NUKEM.begin_level
  },
  ...
  options =
  {
...

    {
      ...
      choices = MISC_STUFF_NUKEM.ROOM_SIZE_MULTIPLIER_CHOICES,
      default = "mixed",
    ...
    },
    {
      ...
      choices = MISC_STUFF_NUKEM.AREA_COUNT_MULTIPLIER_CHOICES,
      default = "mixed",
    ...
    },
    {
      ...
      choices = MISC_STUFF_NUKEM.ROOM_SIZE_CONSISTENCY_CHOICES,
      default = "mixed",
    ...
    { name="big_outdoor_rooms", label=_("Big Outdoors"), choices=STYLE_CHOICES },
    {
      ...
      choices=MISC_STUFF_NUKEM.HEIGHT_CHOICES,
    ...
    { name="windows",     label=_("Windows"),        choices=STYLE_CHOICES },
    {
      ...
      choices=MISC_STUFF_NUKEM.WINDOW_BLOCKING_CHOICES,
    ...
    },
    {
      ...
      choices=MISC_STUFF_NUKEM.RAIL_BLOCKING_CHOICES,
    ...
    { name = "corner_style",
      label=_("Sink Style"),
      choices=MISC_STUFF_NUKEM.SINK_STYLE_CHOICES,
    ...
    },
    {
      ...
      choices=MISC_STUFF_NUKEM.LIQUID_SINK_OPTIONS,
    ...
    { name="brightness_offset",
      ...
      choices=MISC_STUFF_NUKEM.LIGHT_CHOICES,
...
--]]
    {
      ...
      choices=MISC_STUFF_NUKEM.LINEAR_START_CHOICES,
