...
class linedef_t
{
   ...
   public:
    double MinX() const { return std::min(start->x, end->x); }
};
...
class quadtree_c
{
   ...
   public:
    ...
    inline bool Empty() const { return (real_num + mini_num) == 0; }
...
// the partition line.
void DivideOneSeg(seg_t *cur, seg_t *part, quadtree_c *left_list,
                  quadtree_c *right_list, intersection_t **cut_list);
...
void SeparateSegs(quadtree_c *seg_list, seg_t *part, quadtree_c *left_list,
                  quadtree_c *right_list, intersection_t **cut_list);
...
void AddMinisegs(seg_t *part, quadtree_c *left_list, quadtree_c *right_list,
