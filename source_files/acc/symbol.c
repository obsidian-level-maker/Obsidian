...
static symbolNode_t *Insert(char *name, symbolType_t type, symbolNode_t **root);
...
static internFuncDef_t InternalFunctions[] = {
    ...
    {"changeceiling", PCD_CHANGECEILINGDIRECT, PCD_CHANGECEILING, 2, 0, 0, NO,
     NO},
    ...
    {"setlinespecial", PCD_NOP, PCD_SETLINESPECIAL, 7, 4 | 8 | 16 | 32 | 64, 0,
     NO, NO},
    ...
    {"setlinemonsterblocking", PCD_NOP, PCD_SETLINEMONSTERBLOCKING, 2, 0, 0, NO,
     NO},
    ...
    {"consolecommand", PCD_CONSOLECOMMANDDIRECT, PCD_CONSOLECOMMAND, 3, 2 | 4,
     0, NO, NO},
    ...
    {"setaircontrol", PCD_SETAIRCONTROLDIRECT, PCD_SETAIRCONTROL, 1, 0, 0, NO,
     NO},
    {"clearinventory", PCD_NOP, PCD_CLEARINVENTORY, 0, 0, 0, NO, NO},
    {"giveinventory", PCD_GIVEINVENTORYDIRECT, PCD_GIVEINVENTORY, 2, 0, 0, NO,
     NO},
    {"takeinventory", PCD_TAKEINVENTORYDIRECT, PCD_TAKEINVENTORY, 2, 0, 0, NO,
     NO},
    {"checkinventory", PCD_CHECKINVENTORYDIRECT, PCD_CHECKINVENTORY, 1, 0, 0,
     YES, NO},
    ...
    {"localsetmusic", PCD_LOCALSETMUSICDIRECT, PCD_LOCALSETMUSIC, 3, 2 | 4, 0,
     NO, NO},
    {"setstyle", PCD_SETSTYLEDIRECT, PCD_SETSTYLE, 1, 0, 0, NO, NO},
    {"setfont", PCD_SETFONTDIRECT, PCD_SETFONT, 1, 0, 0, NO, NO},
    {"setthingspecial", PCD_NOP, PCD_SETTHINGSPECIAL, 7, 4 | 8 | 16 | 32 | 64,
     0, NO, NO},
    ...
    {"setfloortrigger", PCD_NOP, PCD_SETFLOORTRIGGER, 8, 8 | 16 | 32 | 64 | 128,
     0, NO, NO},
    {"setceilingtrigger", PCD_NOP, PCD_SETCEILINGTRIGGER, 8,
     8 | 16 | 32 | 64 | 128, 0, NO, NO},
    ...
    {"checkactorceilingtexture", PCD_NOP, PCD_CHECKACTORCEILINGTEXTURE, 2, 0, 0,
     YES, NO},
    {"checkactorfloortexture", PCD_NOP, PCD_CHECKACTORFLOORTEXTURE, 2, 0, 0,
     YES, NO},
    ...
    {"thingcountnamesector", PCD_NOP, PCD_THINGCOUNTNAMESECTOR, 3, 0, 0, YES,
     NO},
...
static char *SymbolTypeNames[] = {
    "SY_DUMMY",    "SY_LABEL",      "SY_SCRIPTVAR",   "SY_SCRIPTALIAS",
    "SY_MAPVAR",   "SY_WORLDVAR",   "SY_GLOBALVAR",   "SY_SCRIPTARRAY",
    "SY_MAPARRAY", "SY_WORLDARRAY", "SY_GLOBALARRAY", "SY_SPECIAL",
    "SY_CONSTANT", "SY_INTERNFUNC", "SY_SCRIPTFUNC"};
...
symbolNode_t *SY_FindLocal(char *name) { return Find(name, LocalRoot); }
...
symbolNode_t *SY_InsertGlobalUnique(char *name, symbolType_t type) {
    if (SY_FindGlobal(name) != NULL) {  // Redefined
...
static void ClearShared(symbolNode_t *root) {
    while (root != NULL) {
        if (root->type == SY_SCRIPTFUNC || root->type == SY_MAPVAR ||
