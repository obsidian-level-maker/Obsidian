...
bool Theme_Options_Save(std::string filename) {
    ...
    option_fp << "window_scaling      = " << std::to_string(window_scaling) << "\n";
    option_fp << "font_scaling      = " << std::to_string(font_scaling) << "\n";
    option_fp << "font_theme      = " << std::to_string(font_theme) << "\n";
    option_fp << "widget_theme      = " << std::to_string(widget_theme) << "\n";
    option_fp << "box_theme      = " << std::to_string(box_theme) << "\n";
    option_fp << "button_theme      = " << std::to_string(button_theme) << "\n";
    option_fp << "single_pane = " << std::to_string((single_pane ? 1 : 0)) << "\n";
    option_fp << "use_system_fonts = " << std::to_string((use_system_fonts ? 1 : 0)) << "\n";
    option_fp << "color_scheme      = " << std::to_string(color_scheme) << "\n";
    option_fp << "text_red      = " << std::to_string(text_red) << "\n";
    option_fp << "text_green      = " << std::to_string(text_green) << "\n";
    option_fp << "text_blue      = " << std::to_string(text_blue) << "\n";
    option_fp << "text2_red      = " << std::to_string(text2_red) << "\n";
    option_fp << "text2_green      = " << std::to_string(text2_green) << "\n";
    option_fp << "text2_blue      = " << std::to_string(text2_blue) << "\n";
    option_fp << "bg_red      = " << std::to_string(bg_red) << "\n";
    option_fp << "bg_green      = " << std::to_string(bg_green) << "\n";
    option_fp << "bg_blue      = " << std::to_string(bg_blue) << "\n";
    option_fp << "bg2_red      = " << std::to_string(bg2_red) << "\n";
    option_fp << "bg2_green      = " << std::to_string(bg2_green) << "\n";
    option_fp << "bg2_blue      = " << std::to_string(bg2_blue) << "\n";
    option_fp << "button_red      = " << std::to_string(button_red) << "\n";
    option_fp << "button_green      = " << std::to_string(button_green) << "\n";
    option_fp << "button_blue      = " << std::to_string(button_blue) << "\n";
    option_fp << "gradient_red      = " << std::to_string(gradient_red) << "\n";
    option_fp << "gradient_green      = " << std::to_string(gradient_green) << "\n";
    option_fp << "gradient_blue      = " << std::to_string(gradient_blue) << "\n";
    option_fp << "border_red      = " << std::to_string(border_red) << "\n";
    option_fp << "border_green      = " << std::to_string(border_green) << "\n";
    option_fp << "border_blue      = " << std::to_string(border_blue) << "\n";
    option_fp << "gap_red      = " << std::to_string(gap_red) << "\n";
    option_fp << "gap_green      = " << std::to_string(gap_green) << "\n";
    option_fp << "gap_blue      = " << std::to_string(gap_blue) << "\n";
    option_fp << "\n\n";
...
UI_ThemeWin::UI_ThemeWin(int W, int H, const char *label)
    ...
    opt_text2_color =
        new Fl_Button(cx + W * .05 + opt_text_color->w() + (3 * pad), cy,
    ...
    opt_bg_color =
        new Fl_Button(cx + W * .05 + (opt_text_color->w() + (3 * pad)) * 2, cy,
    ...
    opt_bg2_color =
        new Fl_Button(cx + W * .05 + (opt_text_color->w() + (3 * pad)) * 3, cy,
