...
void redo_cb(Fl_Widget *, void *) {
    ...
    undo_suspend();
    if (!read_file(undo_filename(undo_current + 1, filename, sizeof(filename)),
                   0)) {
...
void undo_checkpoint() {
    ...
    //  printf("undo_checkpoint(): undo_current=%d, undo_paused=%d,
    //  modflag=%d\n",
...
void undo_resume() { undo_paused = 0; }

// Suspend undo checkpoints
void undo_suspend() { undo_paused = 1; }
