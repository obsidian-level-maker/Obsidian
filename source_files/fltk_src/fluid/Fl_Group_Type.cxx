...
Fl_Type *Fl_Group_Type::make() { return Fl_Widget_Type::make(); }
...
void group_cb(Fl_Widget *, void *) {
    ...
    if (!qq || qq->level < 1 ||
        (qq->level == 1 && !strcmp(qq->type_name(), "widget_class"))) {
...
void ungroup_cb(Fl_Widget *, void *) {
    ...
    if (q) q = q->parent;
    if (!q || q->level < 1 ||
        (q->level == 1 && !strcmp(q->type_name(), "widget_class"))) {
...
void Fl_Group_Type::write_code1() { Fl_Widget_Type::write_code1(); }
...
void Fl_Table_Type::add_child(Fl_Type *cc, Fl_Type *before) {
    Fl_Widget_Type *c = (Fl_Widget_Type *)cc;
    Fl_Widget *b = before ? ((Fl_Widget_Type *)before)->o : 0;
    if (((Fl_Table *)o)->children() ==
        1) {  // the FLuid_Table has one extra child
        fl_message(
 ...
 */
void Fl_Group_Type::copy_properties() { Fl_Widget_Type::copy_properties(); }
