...
static void cb_Close(Fl_Button *, void *) { project_window->hide(); }
        ...
        }  // Fl_Button* o
        {
                ...
                o->hide();
                {
                    Fl_Box *o =
                        new Fl_Box(20, 49, 340, 49,
                                   "Use \"name.ext\" to set a file name or "
                                   "just \".ext\" to set extension.");
                    o->align(Fl_Align(132 | FL_ALIGN_INSIDE));
                }  // Fl_Box* o
                {
                    header_file_input =
                        new Fl_Input(119, 103, 252, 20, "Header File:");
                    header_file_input->tooltip(
                    ...
                    header_file_input->callback((Fl_Callback *)header_input_cb,
                                                (void *)(1));
                    header_file_input->when(FL_WHEN_CHANGED);
                }  // Fl_Input* header_file_input
                {
                    code_file_input =
                        new Fl_Input(119, 128, 252, 20, "Code File:");
                    code_file_input->tooltip(
                    ...
                    code_file_input->callback((Fl_Callback *)code_input_cb,
                                              (void *)(1));
                    code_file_input->when(FL_WHEN_CHANGED);
                }  // Fl_Input* code_file_input
                {
                    include_H_from_C_button = new Fl_Check_Button(
                        117, 153, 272, 20, "Include Header from Code");
                    include_H_from_C_button->tooltip(
                        "Include the header file from the code file.");
                    include_H_from_C_button->down_box(FL_DOWN_BOX);
                    include_H_from_C_button->callback(
                        (Fl_Callback *)include_H_from_C_button_cb);
                }  // Fl_Check_Button* include_H_from_C_button
                {
                    use_FL_COMMAND_button = new Fl_Check_Button(
                        117, 176, 272, 20, "Menu shortcuts use FL_COMMAND");
                    use_FL_COMMAND_button->tooltip(
                        "Replace FL_CTRL with FL_COMMAND when generating menu "
                        "shortcut code.");
                    use_FL_COMMAND_button->down_box(FL_DOWN_BOX);
                    use_FL_COMMAND_button->callback(
                        (Fl_Callback *)use_FL_COMMAND_button_cb);
            ...
            }  // Fl_Group* o
            {
                ...
                }  // Fl_Int_Input* i18n_set_input
                {
                    ...
                    i18n_function_input->tooltip(
                        "The function to call to internationalize the labels "
                        "and tooltips.");
...
static void cb_editor_command_input(Fl_Input *, void *) {
    strncpy(G_external_editor_command, editor_command_input->value(),
            sizeof(G_external_editor_command) - 1);
...
static void cb_Close1(Fl_Button *, void *) { settings_window->hide(); }

Fl_Double_Window *make_settings_window() {
    {
        Fl_Double_Window *o = settings_window =
            new Fl_Double_Window(360, 355, "GUI Settings");
        {
        ...
        }  // Fl_Choice* scheme_choice
        {
            ...
            {
                tooltips_button =
                    new Fl_Check_Button(138, 43, 113, 25, "Show Tooltips");
            ...
            {
                completion_button = new Fl_Check_Button(
                    138, 68, 186, 25, "Show Completion Dialogs");
                completion_button->down_box(FL_DOWN_BOX);
                completion_button->labelsize(12);
                completion_button->callback(
                    (Fl_Callback *)cb_completion_button);
                int b;
                fluid_prefs.get("show_completion_dialogs", b, 1);
                completion_button->value(b);
            }  // Fl_Check_Button* completion_button
            {
                openlast_button = new Fl_Check_Button(
                    138, 93, 214, 25, "Open Previous File on Startup");
            ...
            {
                prevpos_button = new Fl_Check_Button(
                    138, 118, 209, 25, "Remember Window Positions");
            ...
            {
                show_comments_button = new Fl_Check_Button(
                    138, 143, 209, 25, "Show Comments in Browser");
                show_comments_button->down_box(FL_DOWN_BOX);
                show_comments_button->labelsize(12);
                show_comments_button->callback(
                    (Fl_Callback *)cb_show_comments_button);
        ...
        {
            recent_spinner =
                new Fl_Spinner(140, 173, 40, 25, "# Recent Files: ");
        ...
        }  // Fl_Spinner* recent_spinner
        {
            ...
            o->color(FL_DARK1);
            {
                use_external_editor_button = new Fl_Check_Button(
                    25, 218, 209, 22, "Use external editor?");
                use_external_editor_button->down_box(FL_DOWN_BOX);
                use_external_editor_button->labelsize(12);
                use_external_editor_button->callback(
                    (Fl_Callback *)cb_use_external_editor_button);
                fluid_prefs.get("use_external_editor", G_use_external_editor,
                                0);
                use_external_editor_button->value(G_use_external_editor);
            }  // Fl_Check_Button* use_external_editor_button
            {
                editor_command_input =
                    new Fl_Input(25, 264, 305, 21, "Editor Command");
                editor_command_input->tooltip(
...
f\n    gedit\n emacs");
                ...
                editor_command_input->callback(
                    (Fl_Callback *)cb_editor_command_input);
                editor_command_input->align(Fl_Align(FL_ALIGN_TOP_LEFT));
                editor_command_input->when(FL_WHEN_CHANGED);
                fluid_prefs.get("external_editor_command",
...
static void cb_Cancel(Fl_Button *, void *) { shell_window->hide(); }
...
Fl_Double_Window *make_shell_window() {
    {
        shell_window = new Fl_Double_Window(365, 125, "Shell Command");
        {
            ...
            shell_command_input->callback(
                (Fl_Callback *)cb_shell_command_input);
        ...
        }  // Fl_Input* shell_command_input
        {
            ...
            shell_writecode_button->callback(
                (Fl_Callback *)cb_shell_writecode_button);
            int b;
        ...
        }  // Fl_Check_Button* shell_writecode_button
        {
            ...
            shell_writemsgs_button->callback(
                (Fl_Callback *)cb_shell_writemsgs_button);
            int b;
        ...
        }  // Fl_Check_Button* shell_writemsgs_button
        {
            ...
            shell_savefl_button->callback(
                (Fl_Callback *)cb_shell_savefl_button);
            int b;
...
static void cb_Close2(Fl_Button *, void *) { grid_window->hide(); }
...
Fl_Double_Window *make_layout_window() {
    {
        ...
        {
            Fl_Int_Input *o = horizontal_input =
                new Fl_Int_Input(116, 10, 50, 25, "x");
        ...
        {
            Fl_Int_Input *o = vertical_input =
                new Fl_Int_Input(179, 10, 50, 25, "pixels");
        ...
        {
            Fl_Int_Input *o = snap_input =
                new Fl_Int_Input(116, 45, 50, 25, "pixel snap");
        ...
        {
            guides_toggle =
                new Fl_Check_Button(116, 80, 110, 25, "Show Guides");
            guides_toggle->tooltip(
        ...
        }  // Fl_Box* o
        {
            Fl_Group *o = new Fl_Group(105, 115, 170, 75);
            {
                ...
                def_widget_size[0]->callback(
                    (Fl_Callback *)default_widget_size_cb, (void *)(8));
            ...
            }  // Fl_Box* o
            {
                ...
                def_widget_size[1]->callback(
                    (Fl_Callback *)default_widget_size_cb, (void *)(11));
            ...
            }  // Fl_Box* o
            {
                ...
                def_widget_size[2]->callback(
                    (Fl_Callback *)default_widget_size_cb, (void *)(14));
            ...
            }  // Fl_Box* o
            {
                ...
                def_widget_size[3]->callback(
                    (Fl_Callback *)default_widget_size_cb, (void *)(18));
            ...
            }  // Fl_Box* o
            {
                ...
                def_widget_size[4]->callback(
                    (Fl_Callback *)default_widget_size_cb, (void *)(24));
            ...
            }  // Fl_Box* o
            {
                ...
                def_widget_size[5]->callback(
                    (Fl_Callback *)default_widget_size_cb, (void *)(32));
...
static void writePrefs() {
    // write all preferences using the array
    {
        Fl_Preferences prefs(Fl_Preferences::SYSTEM, "fltk.org", "fltk");
        Fl_Preferences opt_prefs(prefs, "options");
        if (opt[Fl::OPTION_ARROW_FOCUS][1] == 2)
            opt_prefs.deleteEntry("ArrowFocus");
        else
            opt_prefs.set("ArrowFocus", opt[Fl::OPTION_ARROW_FOCUS][1]);
        if (opt[Fl::OPTION_VISIBLE_FOCUS][1] == 2)
            opt_prefs.deleteEntry("VisibleFocus");
        else
            opt_prefs.set("VisibleFocus", opt[Fl::OPTION_VISIBLE_FOCUS][1]);
        if (opt[Fl::OPTION_DND_TEXT][1] == 2)
            opt_prefs.deleteEntry("DNDText");
        else
            opt_prefs.set("DNDText", opt[Fl::OPTION_DND_TEXT][1]);
        if (opt[Fl::OPTION_SHOW_TOOLTIPS][1] == 2)
            opt_prefs.deleteEntry("ShowTooltips");
        else
            opt_prefs.set("ShowTooltips", opt[Fl::OPTION_SHOW_TOOLTIPS][1]);
        if (opt[Fl::OPTION_FNFC_USES_GTK][1] == 2)
            opt_prefs.deleteEntry("FNFCUsesGTK");
        else
            opt_prefs.set("FNFCUsesGTK", opt[Fl::OPTION_FNFC_USES_GTK][1]);
    }
    {
        Fl_Preferences prefs(Fl_Preferences::USER, "fltk.org", "fltk");
        Fl_Preferences opt_prefs(prefs, "options");
        if (opt[Fl::OPTION_ARROW_FOCUS][0] == 2)
            opt_prefs.deleteEntry("ArrowFocus");
        else
            opt_prefs.set("ArrowFocus", opt[Fl::OPTION_ARROW_FOCUS][0]);
        if (opt[Fl::OPTION_VISIBLE_FOCUS][0] == 2)
            opt_prefs.deleteEntry("VisibleFocus");
        else
            opt_prefs.set("VisibleFocus", opt[Fl::OPTION_VISIBLE_FOCUS][0]);
        if (opt[Fl::OPTION_DND_TEXT][0] == 2)
            opt_prefs.deleteEntry("DNDText");
        else
            opt_prefs.set("DNDText", opt[Fl::OPTION_DND_TEXT][0]);
        if (opt[Fl::OPTION_SHOW_TOOLTIPS][0] == 2)
            opt_prefs.deleteEntry("ShowTooltips");
        else
            opt_prefs.set("ShowTooltips", opt[Fl::OPTION_SHOW_TOOLTIPS][0]);
        if (opt[Fl::OPTION_FNFC_USES_GTK][0] == 2)
            opt_prefs.deleteEntry("FNFCUsesGTK");
        else
            opt_prefs.set("FNFCUsesGTK", opt[Fl::OPTION_FNFC_USES_GTK][0]);
    }
}

void show_global_settings_window() {
    if (!global_settings_window) make_global_settings_window();
    readPrefs();
    refreshUI();
    fl_message(
        "WARNING!\n\n"
...
static void cb_wUserOrSystem(Fl_Choice *, void *) { refreshUI(); }
...
static void cb_Cancel1(Fl_Button *, void *) { global_settings_window->hide(); }
...
Fl_Double_Window *make_global_settings_window() {
    {
        global_settings_window =
            new Fl_Double_Window(400, 378, "FLTK Preferences");
...
dropping text from other applications still works.\n\nDefault is on.");
        ...
        {
            Fl_Group *o =
                new Fl_Group(10, 269, 380, 66, "Native File Chooser Options");
            o->box(FL_GTK_DOWN_BOX);
            o->labelfont(2);
            o->align(Fl_Align(FL_ALIGN_TOP_LEFT | FL_ALIGN_INSIDE));
            {
                wGTKText = new Fl_Choice(245, 300, 100, 25,
                                         "Native File Chooser uses GTK:");
                wGTKText->tooltip(
...
s available.\n\nDefault is on.");
        ...
        }  // Fl_Group* o
        {
            ...
            wUserOrSystem->tooltip(
                "Change settings for the current user, or default values for all users of this\
