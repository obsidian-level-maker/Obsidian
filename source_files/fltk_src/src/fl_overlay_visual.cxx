...
XVisualInfo *fl_find_overlay_visual() {
    ...
    if (XGetWindowProperty(
            fl_display, RootWindow(fl_display, fl_screen), overlayVisualsAtom,
            0L, 10000L, False, overlayVisualsAtom, &actualType, &actualFormat,
    ...
    if (actualType == overlayVisualsAtom && actualFormat == 32) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            int num;
            XVisualInfo *v1 =
                XGetVisualInfo(fl_display, VisualIDMask, &templt, &num);
