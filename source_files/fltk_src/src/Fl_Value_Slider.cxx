...
void Fl_Value_Slider::draw() {
    ...
    Fl_Slider::draw(sxx + Fl::box_dx(box()), syy + Fl::box_dy(box()),
...
int Fl_Value_Slider::handle(int event) {
    ...
    return Fl_Slider::handle(event, sxx + Fl::box_dx(box()),
                             syy + Fl::box_dy(box()), sww - Fl::box_dw(box()),
                             shh - Fl::box_dh(box()));
}

Fl_Hor_Value_Slider::Fl_Hor_Value_Slider(int X, int Y, int W, int H,
                                         const char *l)
