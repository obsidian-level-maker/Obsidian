...
static void getsyscolor(int what, const char *arg,
...
Fl_Image *Fl::scheme_bg_ =
    (Fl_Image *)0;  // current background image for the scheme
#endif
...
int Fl::scheme(const char *s) {
    ...
    if (s) {
        if (!fl_ascii_strcasecmp(s, "none") ||
            !fl_ascii_strcasecmp(s, "base") || !*s)
            s = 0;
