    ...
    if (down_box()) {
        ...
        switch (down_box()) {
            ...
            case _FL_PLASTIC_UP_BOX:
                // Check box...
                draw_box(down_box(), x() + dx, y() + dy, W, W,
            ...
            case _FL_ROUND_UP_BOX:
                ...
                if (value()) {
                    ...
                    if (Fl::is_scheme("gtk+")) {
                        fl_color(FL_SELECTION_COLOR);
                        tW--;
                        fl_pie(x() + tdx - 1, y() + tdy - 1, tW + 3, tW + 3,
                               0.0, 360.0);
                        fl_color(fl_color_average(FL_WHITE, FL_SELECTION_COLOR,
                                                  0.2f));
                    } else
                        fl_color(col);
                    ...
                    if (Fl::is_scheme("gtk+")) {
                        fl_color(fl_color_average(FL_WHITE, FL_SELECTION_COLOR,
                                                  0.5));
                        fl_arc(x() + tdx, y() + tdy, tW + 1, tW + 1, 60.0,
                               180.0);
                    }
                }
                break;
...
Fl_Radio_Light_Button::Fl_Radio_Light_Button(int X, int Y, int W, int H,
                                             const char *l)
