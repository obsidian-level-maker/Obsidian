...
void fl_normal_label(const Fl_Label *o, int X, int Y, int W, int H,
                     Fl_Align align) {
...
static Fl_Label_Draw_F *table[MAX_LABELTYPE] = {
    ...
    // FL_FREE_LABELTYPE+n:
    fl_no_label, fl_no_label, fl_no_label, fl_no_label, fl_no_label,
    fl_no_label, fl_no_label, fl_no_label, fl_no_label};

static Fl_Label_Measure_F *measure[MAX_LABELTYPE];

/** Sets the functions to call to draw and measure a specific labeltype. */
void Fl::set_labeltype(Fl_Labeltype t, Fl_Label_Draw_F *f,
...
/**
   ...
   image; on return, this will contain the size needed to fit the label
*/
