...
static int CALLBACK enumcbw(CONST LOGFONTW *lpelf,
                            CONST TEXTMETRICW * /*lpntm*/, DWORD /*FontType*/,
                            LPARAM p) {
    if (!p && lpelf->lfCharSet != ANSI_CHARSET) return 1;
    char *n = NULL;
    size_t l = wcslen(lpelf->lfFaceName);
    unsigned dstlen =
        fl_utf8fromwc(n, 0, (xchar *)lpelf->lfFaceName, (unsigned)l) +
        1;  // measure the string
    n = (char *)malloc(dstlen);
    // n[fl_unicode2utf((xchar*)lpelf->lfFaceName, l, n)] = 0;
    dstlen = fl_utf8fromwc(n, dstlen, (xchar *)lpelf->lfFaceName,
                           (unsigned)l);  // convert the string
    n[dstlen] = 0;
...
EnumSizeCbW(CONST LOGFONTW * /*lpelf*/, CONST TEXTMETRICW *lpntm,
...
int Fl::get_font_sizes(Fl_Font fnum, int *&sizep) {
    ...
    unsigned l = fl_utf8toUtf16(nm, (unsigned)len, NULL,
