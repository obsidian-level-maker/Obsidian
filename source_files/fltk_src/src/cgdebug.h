...
inline void dbgCGContextClipToRect(CGContextRef a, CGRect b) { CGContextClipToRect(a, b); }
...
inline void dbgCGContextFillRect(CGContextRef a, CGRect b) { CGContextFillRect(a, b); }
...
inline OSStatus dbgQDEndCGContext(CGrafPtr a, CGContextRef *b) { return QDEndCGContext(a, b); }

#define QDEndCGContext(a, b) (dbgLocation(__FILE__, __LINE__) + dbgQDEndCGContext(a, b) + dbgEndl())

inline OSStatus dbgQDBeginCGContext(CGrafPtr a, CGContextRef *b) { return QDBeginCGContext(a, b); }
...
inline void dbgCGContextFillPath(CGContextRef context) { CGContextFillPath(context); }
...
inline void dbgCGContextClosePath(CGContextRef context) { CGContextClosePath(context); }
...
inline void dbgCGContextFlush(CGContextRef context) { CGContextFlush(context); }
...
inline void dbgCGContextSaveGState(CGContextRef context) { CGContextSaveGState(context); }
...
inline void dbgCGContextRestoreGState(CGContextRef context) { CGContextRestoreGState(context); }
