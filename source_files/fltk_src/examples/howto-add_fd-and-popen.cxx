...
// of data Note: FL_SOCKET as 1st argument is used to fix a compiler error(!) on
// Windows 64-bit. Unfortunately we need this in FLTK 1.3 - should hopefully be
// fixed in 1.4 with a better solution.
...
int main(int argc, char *argv[]) {
    ...
    if ((G_fp = popen(PING_CMD, "r")) ==
        NULL) {  // start the external unix command
        perror("popen failed");
        return (1);
    }
