            ...
            switch (Fl::event()) {   // see what FLTK event caused it
                ...
                case FL_KEYBOARD:  // key press in table?
                    ...
                    switch (Fl::e_text[0]) {
                        ...
                        case '1':
                        case '2':
                        case '3':  // any of these should start editing new cell
                        case '4':
                        case '5':
                        case '6':
                        case '7':
                        ...
                        case '-':
                            start_editing(R, C);  // start new edit
                            input->handle(
                                Fl::event());  // pass typed char to input
                            break;
                        case '\r':
...
int main() {
    ...
    table->tab_cell_nav(
        1);  // enable tab navigation of table cells (instead of fltk widgets)
#endif
    table->tooltip(
        "Use keyboard to navigate cells:\n"
