...
int main(int argc, char **argv) {
    ...
    sprintf(version[versions++], "Fl::api_version() = %6d  %s",
            Fl::api_version(),
    ...
    sprintf(version[versions++], "Fl::abi_version() = %6d  %s",
            Fl::abi_version(),
    ...
    sprintf(version[versions++],
            "NOTE: FLTK_ABI_VERSION is deprecated.\n"
    ...
    for (int i = 0; i < 4; i++) {
        ...
        box[2 * i + 1] =
            new Fl_Box(340, 40 + 40 * i, 320, 30, version[2 * i + 1]);
    }
