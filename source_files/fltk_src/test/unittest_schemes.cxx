    ...
    SchemesTest(int X, int Y, int W, int H) : Fl_Group(X, Y, W, H) {
        ...
        if (name) {
            if (strcmp(name, "plastic") == 0) {
                schemechoice->value(1);
            } else if (strcmp(name, "gtk+") == 0) {
                schemechoice->value(2);
            } else if (strcmp(name, "gleam") == 0) {
                schemechoice->value(3);
            }
        }
        ...
        subwin->begin();
        {
            ...
            }  // Fl_Button* o
            {
                ...
                o->selection_color(FL_DARK1);
                {
                    ...
                    { new Fl_Progress(22, 306, 290, 20); }  // Fl_Progress* o
                    {
                ...
                }  // Fl_Group* o
                {
                    ...
                    {
                        Fl_Value_Slider *o =
                            new Fl_Value_Slider(115, 161, 25, 155);
                        o->box(FL_DOWN_BOX);
                    }  // Fl_Value_Slider* o
                    {
                        Fl_Value_Output *o =
                            new Fl_Value_Output(240, 265, 75, 25);
                        o->box(FL_DOWN_BOX);
                    ...
                    {
                        Fl_Value_Input *o =
                            new Fl_Value_Input(155, 265, 75, 25);
                        o->box(FL_DOWN_BOX);
                ...
                }  // Fl_Group* o
                {
                    ...
                    {
                        Fl_Text_Editor *o =
                            new Fl_Text_Editor(180, 160, 125, 55);
                        o->box(FL_DOWN_FRAME);
                        o->color((Fl_Color)80);
                    ...
                    {
                        Fl_Text_Display *o =
                            new Fl_Text_Display(180, 230, 125, 55);
                        o->box(FL_DOWN_FRAME);
                        o->color((Fl_Color)12);
            ...
            {
                Fl_Light_Button *o =
                    new Fl_Light_Button(110, 10, 105, 25, "Light");
                o->box(FL_DOWN_BOX);
            ...
            {
                Fl_Check_Button *o =
                    new Fl_Check_Button(110, 37, 105, 25, "Check");
                o->box(FL_DOWN_FRAME);
            ...
            {
                Fl_Text_Editor *o =
                    new Fl_Text_Editor(220, 53, 100, 29, "down frame");
                o->box(FL_DOWN_FRAME);
                o->color((Fl_Color)19);
                o->selection_color(FL_DARK1);
            ...
            {
                Fl_Text_Editor *o =
                    new Fl_Text_Editor(220, 99, 100, 38, "up frame");
                o->box(FL_UP_FRAME);
                o->color((Fl_Color)19);
                o->selection_color(FL_DARK1);
