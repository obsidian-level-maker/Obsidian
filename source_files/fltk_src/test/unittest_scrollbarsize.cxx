...
class ScrollBarSizeTest : public Fl_Group {
   ...
   public:
    static Fl_Widget *create() {
        return (new ScrollBarSizeTest(TESTAREA_X, TESTAREA_Y, TESTAREA_W,
                                      TESTAREA_H));
    }
    ...
    ScrollBarSizeTest(int X, int Y, int W, int H) : Fl_Group(X, Y, W, H) {
        ...
        Fl_Value_Slider *slide_glob =
            new Fl_Value_Slider(X + 100, Y, 100, 18, "Global Scroll Size");
        slide_glob->value(16);
        ...
        Fl_Value_Slider *slide_browa =
            new Fl_Value_Slider(X + 350, Y, 100, 18, "A: Scroll Size");
        slide_browa->value(0);
