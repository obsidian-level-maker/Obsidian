...
static void centered_text(cairo_t *cr, double x0, double y0, double w0,
                          double h0, const char *my_text) {
...
static void round_button(cairo_t *cr, double x0, double y0, double rect_width,
                         double rect_height, double radius, double r, double g,
                         double b) {
    double x1, y1;
...
int main(int argc, char **argv) {
    fl_message(
        "please configure fltk with CAIRO enabled (--enable-cairo or "
        "--enable-cairoext)");
    return 0;
}
#endif
