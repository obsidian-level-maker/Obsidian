...
void test_box::draw() {
    ...
    fl_color((uchar)(sliders[0]->value()), (uchar)(sliders[1]->value()),
    ...
    dashes[4] = 0;
    fl_line_style(choice[0]->mvalue()->argument() +
...
Fl_Menu_Item style_menu[] = {{"FL_SOLID", 0, 0, (void *)FL_SOLID},
