...
const char *code_keywords[] = {  // List of known C/C++ keywords...
    "and",      "and_eq", "asm",      "bitand",  "bitor",  "break",    "case",
    "catch",    "compl",  "continue", "default", "delete", "do",       "else",
    "false",    "for",    "goto",     "if",      "new",    "not",      "not_eq",
    "operator", "or",     "or_eq",    "return",  "switch", "template", "this",
...
Fl_Menu_Item menuitems[] = {
    ...
    {"Line Numbers", FL_COMMAND + 'l', (Fl_Callback *)linenumbers_cb, 0,
     FL_MENU_TOGGLE},
