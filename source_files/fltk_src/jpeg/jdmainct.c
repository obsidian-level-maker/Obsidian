...
METHODDEF(void)
process_data_crank_post JPP((j_decompress_ptr cinfo, JSAMPARRAY output_buf,
                             JDIMENSION *out_row_ctr,
                             JDIMENSION out_rows_avail));
#endif
 ...
 */
{
    ...
    for (ci = 0, compptr = cinfo->comp_info; ci < cinfo->num_components;
        ...
        rgroup = (compptr->v_samp_factor * compptr->DCT_v_scaled_size) /
                 cinfo->min_DCT_v_scaled_size; /* height of a row group of
                                                  component */
    ...
    switch (mainp->context_state) {
        case CTX_POSTPONED_ROW:
            ...
            (*cinfo->post->post_process_data)(
                cinfo, mainp->xbuffer[mainp->whichptr], &mainp->rowgroup_ctr,
        ...
        case CTX_PREPARE_FOR_IMCU:
            ...
            mainp->rowgroups_avail =
                (JDIMENSION)(cinfo->min_DCT_v_scaled_size - 1);
        ...
        case CTX_PROCESS_IMCU:
             ...
             */
            if (mainp->iMCU_row_ctr == 1) set_wraparound_pointers(cinfo);
            ...
            mainp->rowgroup_ctr =
                (JDIMENSION)(cinfo->min_DCT_v_scaled_size + 1);
            mainp->rowgroups_avail =
                (JDIMENSION)(cinfo->min_DCT_v_scaled_size + 2);
...
jinit_d_main_controller(j_decompress_ptr cinfo, boolean need_full_buffer) {
     ...
     */
    if (cinfo->upsample->need_context_rows) {
        if (cinfo->min_DCT_v_scaled_size <
