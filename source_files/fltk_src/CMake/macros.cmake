...
# "$Id$"
#
# macros.cmake Written by Michael Surette
#
...
macro(FL_ADD_LIBRARY LIBNAME LIBTYPE LIBFILES)
  ...
  if(${LIBTYPE} STREQUAL "SHARED")
    set_target_properties(
      ${LIBRARY_NAME}
      PROPERTIES VERSION ${FLTK_VERSION_FULL}
  ...
  if(MSVC)
    if(OPTION_LARGE_FILE)
      set_target_properties(
        ${LIBRARYNAME} PROPERTIES LINK_FLAGS /LARGEADDRESSAWARE
      )
    endif(OPTION_LARGE_FILE)

    if(${LIBTYPE} STREQUAL "SHARED")
      set_target_properties(
        ${LIBRARY_NAME} PROPERTIES COMPILE_DEFINITIONS "FL_DLL"
      )
    endif(${LIBTYPE} STREQUAL "SHARED")
  endif(MSVC)
...
function(CREATE_EXAMPLE NAME SOURCES LIBRARIES)
  ...
  set_target_properties(${tname} PROPERTIES OUTPUT_NAME ${NAME})
