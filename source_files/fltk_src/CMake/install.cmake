...
configure_file(
  ...
  ${FLTK_BINARY_DIR}/etc/FLTKConfig.cmake @ONLY
)
...
configure_file(
  ...
  ${FLTK_BINARY_DIR}/etc/UseFLTK.cmake @ONLY
)
...
configure_file(
  "${FLTK_SOURCE_DIR}/fltk-config.in" "${FLTK_BINARY_DIR}/bin/fltk-config"
  @ONLY
)
if(UNIX)
  execute_process(
    COMMAND chmod 755 fltk-config WORKING_DIRECTORY "${FLTK_BINARY_DIR}/bin"
  )
endif(UNIX)

install(PROGRAMS ${FLTK_BINARY_DIR}/bin/fltk-config DESTINATION ${FLTK_BINDIR})
...
if(UNIX
  ...
  macro(INSTALL_MAN FILE LEVEL)
    install(
      FILES ${FLTK_SOURCE_DIR}/documentation/src/${FILE}.man
