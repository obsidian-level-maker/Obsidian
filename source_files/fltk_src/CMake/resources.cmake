...
# Doxygen: necessary for HTML and PDF docs find_package(Doxygen)
...
# set (LATEX_FOUND) if (DOXYGEN_FOUND) find_package(LATEX) if (LATEX_COMPILER
# AND NOT LATEX_FOUND) set(LATEX_FOUND YES) endif (LATEX_COMPILER AND NOT
# LATEX_FOUND) endif (DOXYGEN_FOUND)
