...
# The following part is probably wrong but does no harm. This will be removed in
# FLTK 1.4.0. AlbrechtS, Dec 28, 2017. fix no WIN32 defined issue
if(NOT WIN32)
  if(_WIN32)
    set(WIN32 _WIN32)
  elseif(__WIN32__)
...
if(APPLE)
  ...
  if(OPTION_APPLE_X11)
    set(CMAKE_CXX_FLAGS
        "${CMAKE_CXX_FLAGS} -U__APPLE__ -mmacosx-version-min=10.3"
    )
    set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -U__APPLE__")
    set(CMAKE_EXE_LINKER_FLAGS
        "${CMAKE_EXE_LINKER_FLAGS} -L/opt/X11/lib -lfontconfig"
    )
  else()
