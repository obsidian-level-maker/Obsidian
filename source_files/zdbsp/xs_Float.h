...
#if 0
#define _xs_doublecopysgn(a, b) \
    ((int32 *)&a)[_xs_iexp_] &= ~(((int32 *)&b)[_xs_iexp_] & 0x80000000)
...
//  Constants
// ====================================================================================================================
const real64 _xs_doublemagic = real64(
    6755399441055744.0);  // 2^52 * 1.5,  uses limited precisicion to floor
const real64 _xs_doublemagicdelta =
...
#if _xs_DEFAULT_CONVERSION == 0
    // Yes, it is important that two fadds be generated, so you cannot override
    // the dmr passed to xs_CRoundToInt with _xs_doublemagic +
    // _xs_doublemagicdelta. If you do, you'll end up with Banker's Rounding
    // again.
