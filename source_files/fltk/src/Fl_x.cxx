...
// FIXME: warning XFT support here
  ...
  if (sarea) {
    fl_xim_ic = XCreateIC(fl_xim_im, XNInputStyle, (XIMPreeditPosition | XIMStatusArea),
                          XNPreeditAttributes, preedit_attr, XNStatusAttributes, status_attr, NULL);
  }

  if (!fl_xim_ic && predit) {
    fl_xim_ic = XCreateIC(fl_xim_im, XNInputStyle, (XIMPreeditPosition | XIMStatusNothing),
  ...
  if (!fl_xim_ic) {
    ...
    fl_xim_ic = XCreateIC(fl_xim_im, XNInputStyle, (XIMPreeditNothing | XIMStatusNothing), NULL);
  } else {
...
void fl_xim_activate(Window xid) {
  ...
  if (fl_xim_win != xid) {
    ...
    XSetICValues(fl_xim_ic, XNFocusWindow, fl_xim_win, XNClientWindow, fl_xim_win, NULL);
  }
    ...
    if (Fl::first_window()->non_modal() && window != Fl::first_window())
      ...
      KEYPRESS:
        ...
        if (xevent.type == KeyPress) {
          ...
          if (fl_xim_ic) {
            Status status;
            len = XUtf8LookupString(fl_xim_ic, (XKeyPressedEvent *)&xevent.xkey, kp_buffer,
                                    kp_buffer_len, &keysym, &status);
