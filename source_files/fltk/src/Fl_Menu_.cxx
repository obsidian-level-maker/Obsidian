...
int Fl_Menu_::item_pathname_(char *name, int namelen, const Fl_Menu_Item *finditem,
...
void Fl_Menu_::setonly(Fl_Menu_Item *item) {
  ...
  if (!first)
    return; // item does not belong to our menu
