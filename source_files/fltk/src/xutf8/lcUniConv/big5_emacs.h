...
static int big5_0_mbtowc(conv_t conv, ucs4_t *pwc, const unsigned char *s, int n) {
...
static int big5_1_mbtowc(conv_t conv, ucs4_t *pwc, const unsigned char *s, int n) {
  unsigned char c1 = s[0];
  if (c1 >= 0x21 && c1 <= 0x72) {
    if (n >= 2) {
      unsigned char c2 = s[1];
