...
Fl_RGB_Image *Fl_OpenGL_Display_Device::capture_gl_rectangle(Fl_Gl_Window *glw, int x, int y, int w,
                                                             int h) {
...
Fl_RGB_Image *Fl_Gl_Window_Driver::capture_gl_rectangle(int x, int y, int w, int h) {
  ...
  glReadPixels(x, glw->pixel_h() - (y + h), w, h, GL_RGB, GL_UNSIGNED_BYTE, baseAddress);
  glPopClientAttrib();
