...
Fl_Darwin_System_Driver::Fl_Darwin_System_Driver()
  ...
  if (fl_mac_os_version == 0)
    fl_mac_os_version = calc_mac_os_version();
...
int Fl_Darwin_System_Driver::clocale_vsnprintf(char *output, size_t output_size, const char *format,
                                               va_list args) {
#if MAC_OS_X_VERSION_MAX_ALLOWED >= MAC_OS_X_VERSION_10_4
  if (fl_mac_os_version >= 100400) {
    if (!postscript_locale)
...
int Fl_Darwin_System_Driver::file_browser_load_filesystem(Fl_File_Browser *browser, char *filename,
