...
Fl_GDI_Copy_Surface_Driver::Fl_GDI_Copy_Surface_Driver(int w, int h)
  ...
  rect.left = 0;
  rect.top = 0;
  rect.right = (LONG)((w * scaling) * factorw);
  rect.bottom = (LONG)((h * scaling) * factorh);
  ...
  if (hmf != NULL) {
    if (OpenClipboard(NULL)) {
      ...
      int W = Fl_Scalable_Graphics_Driver::floor(width, scaling),
          H = Fl_Scalable_Graphics_Driver::floor(height, scaling);
      RECT rect = {0, 0, W, H};
