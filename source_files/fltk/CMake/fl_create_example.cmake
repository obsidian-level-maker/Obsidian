...
# files must reside in the subdirectory 'mac-resources'.
#
...
macro(CREATE_EXAMPLE NAME SOURCES LIBRARIES)
  ...
  if(FLTK_HAVE_CAIRO)
    fl_target_link_directories(
      ${TARGET_NAME} PRIVATE "${PKG_CAIRO_LIBRARY_DIRS}"
    )
  endif()
  ...
  # *unused* #  if (${ARGC} GREATER 3) *unused* #    foreach (OPTION ${ARGV3})
  # *unused* #      if (${OPTION} STREQUAL "xxx") *unused* #        # do
  # something ... *unused* #      endif () *unused* #    endforeach () *unused*
  # #  endif ()
