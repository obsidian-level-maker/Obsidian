...
# ##############################################################################
#
# The functions (and macros) in this file are defined to simplify CMake code
# that uses features not available in all supported CMake versions. Functions
# should be preferred (rather than macros) because functions have their own
# variable scope.
#
# The function must apply a workaround for older versions or not add code at all
# if there is no suitable workaround.
#
...
# individual members must be separated by ';'. The list may be empty (""). If
# more than one directory is to be added or if the list of directories can be
# empty it *must* be quoted. This function may be called more than once. Each
# invocation adds zero, one, or more directories.
#
# Example:
#
# fl_target_link_directories (fluid PRIVATE "${PKG_CAIRO_LIBRARY_DIRS}")
#
# In this example 'PKG_CAIRO_LIBRARY_DIRS' is platform dependent and can be an
# empty list.
#
# ##############################################################################
