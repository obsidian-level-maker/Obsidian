...
# ##############################################################################
#
# This macro displays the name and value of some CMake variables defined by
# pkg_check_modules().
#
# Syntax:
#
...
#
# pkg_check_modules (CAIRO cairo) fl_debug_pkg (CAIRO cairo)
#
# The first command searches for pkg 'cairo' and stores the results in CMake
# variables with prefix 'CAIRO_'.
#
# The second command displays all relevant variables if the package has been
# found, otherwise only 'CAIRO_FOUND' (empty or false).
#
# ##############################################################################
