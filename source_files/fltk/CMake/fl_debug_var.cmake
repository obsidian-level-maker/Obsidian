...
# ##############################################################################
#
# This macro displays the name and value of a CMake variable. The variable name
# is expanded with spaces to be (at least) <min_len> (currently 30) characters
# wide for better readability. VARNAME must be a string literal, e.g. WIN32 or
# "WIN32".
#
# Syntax: fl_debug_var(VARNAME)
#
# Example: fl_debug_var(WIN32) fl_debug_var("UNIX")
#
# ##############################################################################
...
macro(fl_debug_var name)
  ...
  while(len LESS min_len)
    # add one space until min_len is reached ** string(APPEND var " ") #
    # requires CMake 3.4.x (otherwise loop...)
    set(var "${var} ")
    string(LENGTH "${var}" len)
