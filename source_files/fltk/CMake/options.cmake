...
if(UNIX)
  ...
  if(OPTION_USE_WAYLAND)
    ...
    set(OPTION_USE_PANGO
        TRUE
        CACHE BOOL "use lib Pango"
    )
...
if(OPTION_USE_PANGO AND NOT OPTION_USE_WAYLAND)
  if(NOT X11_Xft_FOUND)
    message(
      STATUS "Pango requires Xft but Xft library or headers could not be found."
    )
    message(
      STATUS
    ...
    if(NOT OPTION_USE_XFT)
      ...
      message(
        STATUS
          "Please enable OPTION_USE_XFT and try again or disable OPTION_USE_PANGO."
      )
      message(FATAL_ERROR "*** Aborting ***")
...
if((X11_Xft_FOUND OR OPTION_USE_WAYLAND) AND OPTION_USE_PANGO)
  ...
  if(PANGOXFT_FOUND
    ...
    if(HAVE_LIB_PANGO
       AND HAVE_LIB_PANGOXFT
       AND HAVE_LIB_GOBJECT
    )
      set(USE_PANGO TRUE)
      ...
      find_path(GLIB_H_PATH glib.h PATHS ${PANGO_H_PREFIX}/glib-2.0
                                         ${PANGO_H_PREFIX}/glib/glib-2.0
      )
      include_directories(
        ${PANGO_H_PREFIX}/pango-1.0 ${GLIB_H_PATH}
        ${PANGOLIB_DIR}/glib-2.0/include
      )
