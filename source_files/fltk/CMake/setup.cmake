...
# ##############################################################################
# initialize internally used variables some of these variables are used to
# *append* other values later
# ##############################################################################
...
if(WIN32)
  # we do no longer define WIN32 or _WIN32 (since FLTK 1.4.0) ... but if we did,
  # we'd define _WIN32 (since FLTK 1.4.0) add_definitions (-D_WIN32)
  if(MSVC)
    add_definitions(-DWIN32_LEAN_AND_MEAN)
    add_definitions(-D_CRT_SECURE_NO_WARNINGS)
    if(NOT MSVC_VERSION VERSION_LESS 1900) # Visual Studio 2015
      add_compile_options(/utf-8) # equivalent to `/source-charset:utf-8
