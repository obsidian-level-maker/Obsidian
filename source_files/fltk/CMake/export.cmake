...
if(FLTK_BUILD_FLUID)
  ...
  export(TARGETS ${FLUID_EXPORT} ${FLTK_LIBRARIES}
         FILE ${CMAKE_CURRENT_BINARY_DIR}/FLTK-Targets.cmake
  )
else()
  export(TARGETS ${FLTK_LIBRARIES}
         FILE ${CMAKE_CURRENT_BINARY_DIR}/FLTK-Targets.cmake
  )
endif()
...
configure_file(
  ...
  ${CMAKE_CURRENT_BINARY_DIR}/FLTK-Functions.cmake COPYONLY
)
...
configure_file(
  ...
  "${CMAKE_CURRENT_BINARY_DIR}/fltk-config" @ONLY
)

# Set execute permissions on fltk-config in build dir Note: file(CHMOD)
# available since CMake 3.19, use fallback before CMake 3.19
...
configure_file(
  ...
  "${CMAKE_CURRENT_BINARY_DIR}/${CONFIG_H}" @ONLY
)
...
if(OPTION_CREATE_LINKS)
  ...
  configure_file(
    ...
    "${CMAKE_CURRENT_BINARY_DIR}/install-symlinks.cmake" @ONLY
  )
