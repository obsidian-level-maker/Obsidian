...
Resizebox::Resizebox(int X, int Y, int W, int H, const char *T)
  ...
  Fl_Box *b;
  b = new Fl_Box(FL_FRAME_BOX, X + Ax, Y + Ay, Aw, Ah, "A");
  b->color(14);
  b = new Fl_Box(FL_FRAME_BOX, X + Bx, Y + Ay, Aw, Ah, "B");
  b->color(9);
  b = new Fl_Box(FL_FRAME_BOX, X + Cx, Y + Ay, Aw, Ah, "C");
  b->color(10);
  b = new Fl_Box(FL_FRAME_BOX, X + Dx, Y + Ay, Aw, Ah, "D");
  b->color(11);
  b = new Fl_Box(FL_FRAME_BOX, X + Ax, Y + Ey, Aw, Ah, "E");
  b->color(9);
  b = new Fl_Box(FL_FRAME_BOX, X + Bx, Y + Ey, Rw, Rh, "R");
  b->color(3);
  b->label("resizable");
  m_box = b;
  b = new Fl_Box(FL_FRAME_BOX, X + Dx, Y + Ey, Aw, Ah, "F");
  b->color(12);
  b = new Fl_Box(FL_FRAME_BOX, X + Ax, Y + Gy, Aw, Ah, "G");
  b->color(10);
  b = new Fl_Box(FL_FRAME_BOX, X + Dx, Y + Gy, Aw, Ah, "H");
  b->color(13);
  b = new Fl_Box(FL_FRAME_BOX, X + Ax, Y + Iy, Aw, Ah, "I");
  b->color(11);
  b = new Fl_Box(FL_FRAME_BOX, X + Bx, Y + Iy, Aw, Ah, "J");
  b->color(12);
  b = new Fl_Box(FL_FRAME_BOX, X + Cx, Y + Iy, Aw, Ah, "K");
  b->color(13);
  b = new Fl_Box(FL_FRAME_BOX, X + Dx, Y + Iy, Aw, Ah, "L");
  b->color(14);
  b = new Fl_Box(FL_FRAME_BOX, X + Ax, Y + My, Mw, Ah, "M");
  b->color(12);
  b = new Fl_Box(FL_FRAME_BOX, X + Nx, Y + Ay, Aw, Nh, "N");
  b->color(13);
