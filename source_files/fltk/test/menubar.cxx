...
Fl_Menu_Item pulldown[] = {
    {"Red", FL_ALT + 'r'},    {"Green", FL_ALT + 'g'},
    {"Blue", FL_ALT + 'b'},   {"Strange", FL_ALT + 's', 0, 0, FL_MENU_INACTIVE},
    {"&Charm", FL_ALT + 'c'}, {"Truth", FL_ALT + 't'},
    {"Beauty", FL_ALT + 'b'}, {0}};

#ifdef __APPLE__
Fl_Menu_Item menu_location[] = {{"Fl_Menu_Bar", 0, 0, 0, FL_MENU_VALUE},
                                {
                                    "Fl_Sys_Menu_Bar",
                                },
                                {0}};
...
int main(int argc, char **argv) {
  ...
  Fl_Menu_Bar menubar(0, 0, WIDTH, 30);
  ...
  menus[1] = &mb1;
  Fl_Choice ch(300, 100, 80, 25, "&choice:");
  ch.menu(pulldown);
...
#ifdef __APPLE__
  Fl_Menu_Item custom[] = {{"Preferences…", 0, test_cb, NULL, FL_MENU_DIVIDER},
