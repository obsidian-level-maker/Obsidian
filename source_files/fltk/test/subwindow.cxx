...
int testwindow::handle(int e) {
  ...
  if (e == FL_KEYBOARD && Fl::event_text()[0]) {
    if (Fl::event_key() == FL_Escape || Fl::event_command())
      return 0;
    key = Fl::event_text()[0];
    cx = Fl::event_x();
    cy = Fl::event_y();
...
int main(int argc, char **argv) {
  testwindow *window = new testwindow(FL_UP_BOX, 400, 400, "outer");
  ...
  testwindow *subwindow = new testwindow(FL_DOWN_BOX, 100, 100, 200, 200, "inner");
