...
class SimpleTerminal : public Fl_Group {
  ...
  void AnsiTestPattern(Fl_Simple_Terminal *tty) {
    tty->append("\033[30mBlack          Courier 14\033[0m Normal text\n"
                ...
                "\n"
                "\033[31mRed\033[32mGreen\033[33mYellow\033[34mBlue\033[35mMagenta\033[36mCyan\033["
                "37mWhite\033[0m - "
                "\033[31mX\033[32mX\033[33mX\033[34mX\033[35mX\033[36mX\033[37mX\033[0m\n"
                "\033[41mRed\033[42mGreen\033[43mYellow\033[44mBlue\033[45mMagenta\033[46mCyan\033["
                "47mWhite\033[0m - "
...
public:
  ...
  SimpleTerminal(int x, int y, int w, int h)
    : Fl_Group(x, y, w, h) {
    static Fl_Text_Display::Style_Table_Entry my_stable[] = {
        // 10 entry grayscale
