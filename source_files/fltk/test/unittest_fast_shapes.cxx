...
void draw_fast_shapes() {
  ...
  fl_point(a + 25 + 4, b);
  fl_point(a + 25, b + 4);
  fl_point(a + 25 + 20, b + 19);
  fl_point(a + 25 + 19, b + 20);
  fl_point(a + 25 + 16, b + 20);
  fl_point(a + 25 + 20, b + 16);
  fl_color(FL_RED);
  fl_point(a + 25 + 2, b + 2);
  fl_point(a + 25 + 18, b + 18);
  fl_color(FL_BLACK);
...
public:
  ...
  RectTest(int x, int y, int w, int h)
    : Fl_Group(x, y, w, h) {
    ...
    t->tooltip( // Title:
        ...
        // Things to look out for:
        "If green pixels are missing or red pixels are showing, rectangular frame drawing schould "
        "be adjusted (see fl_rect).\n\n"
        "If red pixels show in the corners of the frame in hidpi mode, line endings should be "
        "adjusted.");
    b += 24;
    ...
    t->tooltip( // Title:
        ...
        // Description:
        "This draws a 3 units wide black frame, surrounded on the inside and outside by a green "
        "frame.\n\n"
        // Things to look out for:
        "If green pixels are missing or red pixels are showing, line width schould be adjusted "
        "(see fl_line_style).\n\n"
        "If red pixels show in the corners of the frame in hidpi mode, line endings should be "
        "adjusted.");
    b += 24;
