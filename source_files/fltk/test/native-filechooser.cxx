...
int main(int argc, char **argv) {
  ...
  if (argc > argn && strncmp(argv[argn], "-psn_", 5) == 0)
    ++argn;
#endif
...
#define TAB "&lt;Tab&gt;"
    ...
    view->value("The Filter can be one or more filter patterns, one per line.\n"
                ...
                " and a wildcard (e.g. <tt>\"Text Files" TAB "*.txt\"</tt>)</li>\n"
                "</ul>\n"
                "In the above \"Filter\" field, you can use <b><font color=#55f "
                "face=Courier>Ctrl-I</font></b> to enter " TAB " characters as needed.<br>\n"
                "Example:<pre>\n"
                "\n"
    ...
    Fl_Button *but =
        new Fl_Button(win->w() - x - 10, win->h() - TERMINAL_HEIGHT - 25 - 10, 80, 25, "Pick File");
    but->callback(PickFile_CB);

    Fl_Button *butdir =
        new Fl_Button(but->x() - x - 10, win->h() - TERMINAL_HEIGHT - 25 - 10, 80, 25, "Pick Dir");
