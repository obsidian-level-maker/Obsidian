...
jpeg_fdct_7x7(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col) {
  ...
  for (ctr = 0; ctr < 7; ctr++) {
    ...
    z1 = tmp0 + tmp2;
    dataptr[DCTSIZE * 0] =
        (DCTELEM)DESCALE(MULTIPLY(z1 + tmp1 + tmp3, FIX(1.306122449)), /* 64/49 */
                         CONST_BITS + PASS1_BITS);
    tmp3 += tmp3;
    z1 -= tmp3;
    z1 -= tmp3;
    ...
    dataptr[DCTSIZE * 4] =
        (DCTELEM)DESCALE(z2 + z3 - MULTIPLY(tmp1 - tmp3, FIX(0.923568041)), /* c2+c6-c4 */
                         CONST_BITS + PASS1_BITS);
...
jpeg_fdct_6x6(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col) {
  ...
  for (ctr = 0; ctr < 6; ctr++) {
    ...
    dataptr[DCTSIZE * 2] = (DCTELEM)DESCALE(MULTIPLY(tmp12, FIX(2.177324216)), /* c2 */
                                            CONST_BITS + PASS1_BITS);
    dataptr[DCTSIZE * 4] =
        (DCTELEM)DESCALE(MULTIPLY(tmp10 - tmp11 - tmp11, FIX(1.257078722)), /* c4 */
                         CONST_BITS + PASS1_BITS);
    ...
    dataptr[DCTSIZE * 1] =
        (DCTELEM)DESCALE(tmp10 + MULTIPLY(tmp0 + tmp1, FIX(1.777777778)), /* 16/9 */
                         CONST_BITS + PASS1_BITS);
    dataptr[DCTSIZE * 3] =
        (DCTELEM)DESCALE(MULTIPLY(tmp0 - tmp1 - tmp2, FIX(1.777777778)), /* 16/9 */
                         CONST_BITS + PASS1_BITS);
    dataptr[DCTSIZE * 5] =
        (DCTELEM)DESCALE(tmp10 + MULTIPLY(tmp2 - tmp1, FIX(1.777777778)), /* 16/9 */
                         CONST_BITS + PASS1_BITS);
...
jpeg_fdct_9x9(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col) {
  ...
  for (ctr = DCTSIZE - 1; ctr >= 0; ctr--) {
    ...
    dataptr[DCTSIZE * 3] =
        (DCTELEM)DESCALE(MULTIPLY(tmp10 - tmp12 - tmp13, FIX(1.935399303)), /* c3 */
                         CONST_BITS + 2);
...
jpeg_fdct_11x11(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col) {
  ...
  for (ctr = DCTSIZE - 1; ctr >= 0; ctr--) {
    ...
    dataptr[DCTSIZE * 0] = (DCTELEM)DESCALE(
        MULTIPLY(tmp0 + tmp1 + tmp2 + tmp3 + tmp4 + tmp5, FIX(1.057851240)), /* 128/121 */
        CONST_BITS + 2);
    tmp5 += tmp5;
    tmp0 -= tmp5;
    tmp1 -= tmp5;
    ...
    dataptr[DCTSIZE * 2] =
        (DCTELEM)DESCALE(z1 + z2 - MULTIPLY(tmp3, FIX(1.077210542)) /* c2+c8-c6 */
                             - MULTIPLY(tmp4, FIX(1.471445400)),    /* c4+c10 */
                         CONST_BITS + 2);
    dataptr[DCTSIZE * 4] =
        (DCTELEM)DESCALE(z2 + z3 + MULTIPLY(tmp1, FIX(0.065941844)) /* c4-c6-c10 */
                             - MULTIPLY(tmp2, FIX(1.435427942))     /* c2 */
                             + MULTIPLY(tmp4, FIX(0.621472312)),    /* c8 */
                         CONST_BITS + 2);
    dataptr[DCTSIZE * 6] =
        (DCTELEM)DESCALE(z1 + z3 - MULTIPLY(tmp0, FIX(1.714276708)) /* c2+c4-c6 */
...
jpeg_fdct_12x12(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col) {
  ...
  for (;;) {
    ...
    dataptr[4] = (DCTELEM)DESCALE(MULTIPLY(tmp10 - tmp12, FIX(1.224744871)), /* c4 */
                                  CONST_BITS);
    dataptr[2] =
        (DCTELEM)DESCALE(tmp14 - tmp15 + MULTIPLY(tmp13 + tmp15, FIX(1.366025404)), /* c2 */
                         CONST_BITS);
  ...
  for (ctr = DCTSIZE - 1; ctr >= 0; ctr--) {
    ...
    dataptr[DCTSIZE * 0] =
        (DCTELEM)DESCALE(MULTIPLY(tmp10 + tmp11 + tmp12, FIX(0.888888889)), /* 8/9 */
                         CONST_BITS + 1);
    dataptr[DCTSIZE * 6] =
        (DCTELEM)DESCALE(MULTIPLY(tmp13 - tmp14 - tmp15, FIX(0.888888889)), /* 8/9 */
                         CONST_BITS + 1);
...
jpeg_fdct_13x13(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col) {
  ...
  for (ctr = DCTSIZE - 1; ctr >= 0; ctr--) {
    ...
    dataptr[DCTSIZE * 0] = (DCTELEM)DESCALE(
        MULTIPLY(tmp0 + tmp1 + tmp2 + tmp3 + tmp4 + tmp5 + tmp6, FIX(0.757396450)), /* 128/169 */
        CONST_BITS + 1);
    tmp6 += tmp6;
    tmp0 -= tmp6;
    tmp1 -= tmp6;
...
jpeg_fdct_14x14(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col) {
  ...
  for (;;) {
    ...
    dataptr[3] = (DCTELEM)DESCALE(tmp10 + tmp12 - MULTIPLY(tmp1, FIX(0.424103948)) /* c3-c9-c13 */
                                  ...
                                  CONST_BITS);
    dataptr[1] = (DCTELEM)DESCALE(tmp11 + tmp12 + tmp3 + tmp6 -
  ...
  for (ctr = DCTSIZE - 1; ctr >= 0; ctr--) {
    ...
    dataptr[DCTSIZE * 0] =
        (DCTELEM)DESCALE(MULTIPLY(tmp10 + tmp11 + tmp12 + tmp13, FIX(0.653061224)), /* 32/49 */
                         CONST_BITS + 1);
    tmp13 += tmp13;
    dataptr[DCTSIZE * 4] =
        (DCTELEM)DESCALE(MULTIPLY(tmp10 - tmp13, FIX(0.832106052)) +     /* c4 */
    ...
    dataptr[DCTSIZE * 5] =
        (DCTELEM)DESCALE(tmp10 + tmp11 - MULTIPLY(tmp2, FIX(1.550341076)) /* c3+c5-c13 */
                             + MULTIPLY(tmp4, FIX(0.731428202)),          /* c1+c11-c9 */
                         CONST_BITS + 1);
    tmp12 = MULTIPLY(tmp0 + tmp1, FIX(0.871740478)) + /* c3 */
            MULTIPLY(tmp5 - tmp6, FIX(0.305035186));  /* c11 */
    dataptr[DCTSIZE * 3] =
        (DCTELEM)DESCALE(tmp10 + tmp12 - MULTIPLY(tmp1, FIX(0.276965844)) /* c3-c9-c13 */
                             - MULTIPLY(tmp5, FIX(2.004803435)),          /* c1+c5+c11 */
                         CONST_BITS + 1);
    dataptr[DCTSIZE * 1] =
        (DCTELEM)DESCALE(tmp11 + tmp12 + tmp3 - MULTIPLY(tmp0, FIX(0.735987049)) /* c3+c5-c1 */
...
jpeg_fdct_16x16(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col) {
  ...
  for (;;) {
    ...
    dataptr[4] =
        (DCTELEM)DESCALE(MULTIPLY(tmp10 - tmp13, FIX(1.306562965)) +   /* c4[16] = c2[8] */
