...
public:
  ...
  Fl_Widget *widget(int x, int y, int w, int h) { return new Fl_Box(x, y, w, h, "label"); }
...
static Fl_Menu_Item buttontype_menu[] = {{"Normal", 0, 0, (void *)0},
...
public:
  ...
  Fl_Widget *widget(int x, int y, int w, int h) { return new Fl_Button(x, y, w, h, "button"); }
...
static Fl_Menu_Item browser_type_menu[] = {{"No Select", 0, 0, (void *)FL_NORMAL_BROWSER},
...
static Fl_Menu_Item counter_type_menu[] = {
    {"Normal", 0, 0, (void *)FL_NORMAL_COUNTER}, {"Simple", 0, 0, (void *)FL_SIMPLE_COUNTER}, {0}};
...
public:
  ...
  Fl_Widget *widget(int x, int y, int w, int h) { return new Fl_Counter(x, y, w, h, "counter:"); }
...
static Fl_Menu_Item spinner_type_menu[] = {
    {"Integer", 0, 0, (void *)FL_INT_INPUT}, {"Float", 0, 0, (void *)FL_FLOAT_INPUT}, {0}};
...
public:
  ...
  Fl_Widget *widget(int x, int y, int w, int h) { return new Fl_Spinner(x, y, w, h, "spinner:"); }
...
static Fl_Menu_Item input_type_menu[] = {
    {"Normal", 0, 0, (void *)FL_NORMAL_INPUT}, {"Multiline", 0, 0, (void *)FL_MULTILINE_INPUT},
    {"Secret", 0, 0, (void *)FL_SECRET_INPUT}, {"Int", 0, 0, (void *)FL_INT_INPUT},
    {"Float", 0, 0, (void *)FL_FLOAT_INPUT},   {0}};
...
public:
  ...
  Fl_Widget *widget(int x, int y, int w, int h) { return new Fl_Clock(x, y, w, h); }
...
public:
  ...
  Fl_Widget *widget(int x, int y, int w, int h) { return new Fl_Adjuster(x, y, w, h); }
...
static Fl_Menu_Item dial_type_menu[] = {{"Dot", 0, 0, (void *)0},
...
public:
  ...
  Fl_Widget *widget(int x, int y, int w, int h) { return new Fl_Dial(x, y, w, h); }
...
static Fl_Menu_Item roller_type_menu[] = {
    {"Vertical", 0, 0, (void *)0}, {"Horizontal", 0, 0, (void *)FL_HORIZONTAL}, {0}};
...
public:
  ...
  Fl_Widget *widget(int x, int y, int w, int h) { return new Fl_Roller(x, y, w, h); }
...
static Fl_Menu_Item slider_type_menu[] = {{"Vertical", 0, 0, (void *)FL_VERT_SLIDER},
...
public:
  ...
  Fl_Widget *widget(int x, int y, int w, int h) { return new Fl_Slider(x, y, w, h, "slider:"); }
...
static Fl_Menu_Item scrollbar_type_menu[] = {
    {"Vertical", 0, 0, (void *)FL_VERT_SLIDER}, {"Horizontal", 0, 0, (void *)FL_HOR_SLIDER}, {0}};
...
public:
  ...
  Fl_Widget *widget(int x, int y, int w, int h) { return new Fl_Scrollbar(x, y, w, h); }
...
static Fl_Menu_Item output_type_menu[] = {{"Normal", 0, 0, (void *)FL_NORMAL_OUTPUT},
...
Fl_Menu_Item New_Menu[] = {{"Code", 0, 0, 0, FL_SUBMENU},
