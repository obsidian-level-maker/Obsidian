...
if(NOT JPEG_LIBRARY)
  find_library(
    ...
    NAMES ${jpeg_names}
    PATHS /usr/lib /lib
    NO_DEFAULT_PATH NAMES_PER_DIR
  )
  find_library(
    JPEG_LIBRARY_DEBUG
    NAMES ${jpeg_names_debug}
    PATHS /usr/lib /lib
    NO_DEFAULT_PATH NAMES_PER_DIR
  )
...
if(JPEG_INCLUDE_DIR)
  ...
  set(_JPEG_CONFIG_HEADERS
      "${JPEG_INCLUDE_DIR}/jpeglib.h" ${_JPEG_CONFIG_HEADERS_FEDORA}
  ...
  foreach(_JPEG_CONFIG_HEADER IN LISTS _JPEG_CONFIG_HEADERS)
    ...
    file(STRINGS "${_JPEG_CONFIG_HEADER}" jpeg_lib_version
  ...
  if(NOT TARGET JPEG::JPEG)
    ...
    if(JPEG_INCLUDE_DIRS)
      set_target_properties(
        JPEG::JPEG PROPERTIES INTERFACE_INCLUDE_DIRECTORIES
                              "${JPEG_INCLUDE_DIRS}"
      )
    endif()
