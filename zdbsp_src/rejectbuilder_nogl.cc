...
BYTE *FRejectBuilderNoGL::GetReject ()
{
	return Reject;
}
...
void FRejectBuilderNoGL::HullSides (const BBox &box1, const BBox &box2, FPoint sides[4])
{
...
int FRejectBuilderNoGL::PointOnSide (const FPoint *pt, const FPoint &lpt1, const FPoint &lpt2)
{
