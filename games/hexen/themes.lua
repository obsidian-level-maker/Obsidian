...
HEXEN.ROOM_THEMES =
{
  ...
  desert_Hallway_vent_room_stone =
  {
    env = "hallway",
    group = "vent",
    prob = 50,
  ...
  desert_Hallway_curve_room_stone =
  {
    env = "hallway",
    group = "curve",
    prob = 50,
  ...
  desert_Hallway_deuce_room_stone =
  {
    env = "hallway",
    group = "deuce",
    prob = 50,
