...
DOOM2.FACTORY.DM_SCENERY_PREFABS =
{
  pillar_COMPWERD =
  {
...
DOOM2.FACTORY.DM_FEATURE_PREFABS =
{
...
DOOM2.FACTORY.DM_WINDOW_PREFABS =
{
  window_narrow =
  {
...
DOOM2.FACTORY.DM_DEATHMATCH_EXITS =
{
...
DOOM2.FACTORY.DM_QUEST_LEN_PROBS =
{
  ----------  2   3   4   5   6   7   8  9  10  -------
...
DOOM2.FACTORY.DM_MONSTER_WEAPON_PREFS =
{
  zombie  = { shotty=6.0 },
  shooter = { shotty=6.0 },
  imp     = { shotty=6.0 },
...
DOOM2.FACTORY.DM_INITIAL_MODEL =
{
  doomguy =
  {
...
DOOM2.FACTORY.D2_FEATURE_PREFABS =
{
  overhang3_METAL6 =
  {
    prefab = "OVERHANG_3",
...
DOOM2.FACTORY.D2_THEMES =
{
}

------------------------------------------------------------

DOOM2.FACTORY.D2_QUESTS =
{
  key =
  {
...
DOOM2.FACTORY.D2_EPISODE_THEMES =
{
...
DOOM2.FACTORY.D2_SECRET_KINDS =
{
  MAP31 = "wolfy",
  MAP32 = "wolfy",
}

DOOM2.FACTORY.D2_SECRET_EXITS =
{
  MAP15 = true,
  MAP31 = true,
}

DOOM2.FACTORY.D2_LEVEL_BOSSES =
{
  MAP07 = "mancubus",
  MAP20 = "spider",
  MAP30 = "boss_brain",
...
function DOOM2.get_factory_levels(episode)

  assert(GAME.FACTORY.sky_info)

  local level_list = {}

  local theme_probs = DOOM2.FACTORY.D2_EPISODE_THEMES[episode]
  if OB_CONFIG.length ~= "full" then
    theme_probs = DOOM2.FACTORY.D2_EPISODE_THEMES[4]
  end
  assert(theme_probs)

  local ep_start  = DOOM2.FACTORY.D2_EPISODE_INFO[episode].start
  local ep_length = DOOM2.FACTORY.D2_EPISODE_INFO[episode].len
  ...
  for map = 1,ep_length do
    ...
    if episode == 2 and map >= 10 then
      ...
      Level.sky_info = DOOM2.FACTORY.D2_SKY_INFO[3]
      Level.theme_probs = { WOLF=10 }
      Level.toughness_factor = 1.2
    end

---!!! Level.boss_kind   = DOOM2.FACTORY.D2_LEVEL_BOSSES[Level.name]
    Level.secret_kind = DOOM2.FACTORY.D2_SECRET_KINDS[Level.name]
    Level.secret_exit = DOOM2.FACTORY.D2_SECRET_EXITS[Level.name]

    std_decide_quests(Level, DOOM2.FACTORY.D2_QUESTS, DOOM2.FACTORY.DM_QUEST_LEN_PROBS)
...
function DOOM2.factory_setup()
  ...
  GAME.FACTORY = 
  {
    ...
    monsters = DOOM2.FACTORY.DM_MONSTERS,
    bosses   = DOOM2.FACTORY.DM_BOSSES,
    weapons  = DOOM2.FACTORY.DM_WEAPONS,

    things = DOOM2.FACTORY.DM_THINGS,

    mon_give       = DOOM2.FACTORY.DM_MONSTER_GIVE,
    mon_weap_prefs = DOOM2.FACTORY.DM_MONSTER_WEAPON_PREFS,
    initial_model  = DOOM2.FACTORY.DM_INITIAL_MODEL,

    pickups = DOOM2.FACTORY.DM_PICKUPS,
    pickup_stats = { "health", "bullet", "shell", "rocket", "cell" },
    niceness = DOOM2.FACTORY.DM_NICENESS,

    dm = DOOM2.FACTORY.DM_DEATHMATCH,
    dm_exits = DOOM2.FACTORY.DM_DEATHMATCH_EXITS,

    combos    = DOOM2.FACTORY.DM_COMBOS,
    exits     = DOOM2.FACTORY.DM_EXITS,
    hallways  = DOOM2.FACTORY.DM_HALLWAYS,

    hangs     = DOOM2.FACTORY.DM_OVERHANGS,
    pedestals = DOOM2.FACTORY.DM_PEDESTALS,
    mats      = DOOM2.FACTORY.DM_MATS,
    crates    = DOOM2.FACTORY.DM_CRATES,

    liquids   = DOOM2.FACTORY.DM_LIQUIDS,
    switches  = DOOM2.FACTORY.DM_SWITCHES,
    doors     = DOOM2.FACTORY.DM_DOORS,
    key_doors = DOOM2.FACTORY.DM_KEY_DOORS,
    lifts     = DOOM2.FACTORY.DM_LIFTS,

    images    = DOOM2.FACTORY.DM_IMAGES,
    lights    = DOOM2.FACTORY.DM_LIGHTS,

    rooms     = DOOM2.FACTORY.DM_ROOMS,
    themes    = DOOM2.FACTORY.DM_THEMES,

    sc_fabs   = DOOM2.FACTORY.DM_SCENERY_PREFABS,
    feat_fabs = DOOM2.FACTORY.DM_FEATURE_PREFABS,
    wall_fabs = DOOM2.FACTORY.DM_WALL_PREFABS,

    door_fabs = DOOM2.FACTORY.DM_DOOR_PREFABS,
    arch_fabs = DOOM2.FACTORY.DM_ARCH_PREFABS,
    win_fabs  = DOOM2.FACTORY.DM_WINDOW_PREFABS,
    misc_fabs = DOOM2.FACTORY.DM_MISC_PREFABS,
  ...
  GAME.FACTORY.level_func = DOOM2.get_factory_levels

  GAME.FACTORY.quests   = DOOM2.FACTORY.D2_QUESTS
  GAME.FACTORY.sky_info = DOOM2.FACTORY.D2_SKY_INFO

  GAME.FACTORY.themes   = table.merge_w_copy(GAME.FACTORY.themes,   DOOM2.FACTORY.D2_THEMES)
  GAME.FACTORY.rooms    = table.merge_w_copy(GAME.FACTORY.rooms,    DOOM2.FACTORY.D2_ROOMS)
  GAME.FACTORY.monsters = table.merge_w_copy(GAME.FACTORY.monsters, DOOM2.FACTORY.D2_MONSTERS)

  GAME.FACTORY.combos   = table.merge_w_copy(GAME.FACTORY.combos,   DOOM2.FACTORY.D2_COMBOS)
  GAME.FACTORY.hallways = table.merge_w_copy(GAME.FACTORY.hallways, DOOM2.FACTORY.D2_HALLWAYS)
  GAME.FACTORY.exits    = table.merge_w_copy(GAME.FACTORY.exits,    DOOM2.FACTORY.D2_EXITS)

  GAME.FACTORY.rails = DOOM2.FACTORY.D2_RAILS

  GAME.FACTORY.hangs   = table.merge_w_copy(GAME.FACTORY.hangs,   DOOM2.FACTORY.D2_OVERHANGS)
  GAME.FACTORY.crates  = table.merge_w_copy(GAME.FACTORY.crates,  DOOM2.FACTORY.D2_CRATES)
  GAME.FACTORY.mats    = table.merge_w_copy(GAME.FACTORY.mats,    DOOM2.FACTORY.D2_MATS)
  GAME.FACTORY.doors   = table.merge_w_copy(GAME.FACTORY.doors,   DOOM2.FACTORY.D2_DOORS)
  GAME.FACTORY.lights  = table.merge_w_copy(GAME.FACTORY.lights,  DOOM2.FACTORY.D2_LIGHTS)
  GAME.FACTORY.liquids = table.merge_w_copy(GAME.FACTORY.liquids, DOOM2.FACTORY.D2_LIQUIDS)

  GAME.FACTORY.sc_fabs   = table.merge_w_copy(GAME.FACTORY.sc_fabs,   DOOM2.FACTORY.D2_SCENERY_PREFABS)
  GAME.FACTORY.feat_fabs = table.merge_w_copy(GAME.FACTORY.feat_fabs, DOOM2.FACTORY.D2_FEATURE_PREFABS)
  GAME.FACTORY.wall_fabs = table.merge_w_copy(GAME.FACTORY.wall_fabs, DOOM2.FACTORY.D2_WALL_PREFABS)
  GAME.FACTORY.door_fabs = table.merge_w_copy(GAME.FACTORY.door_fabs, DOOM2.FACTORY.D2_DOOR_PREFABS)
  GAME.FACTORY.misc_fabs = table.merge_w_copy(GAME.FACTORY.misc_fabs, DOOM2.FACTORY.D2_MISC_PREFABS)
  ...
  GAME.FACTORY.PREFABS = DOOM2.FACTORY.PREFABS
