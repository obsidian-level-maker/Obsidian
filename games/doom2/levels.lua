...
DOOM2.PREBUILT_LEVELS =
{
  MAP30 =
  {
    { prob=50, file="games/doom2/data/boss2/icon1.wad", map="MAP30" },
    { prob=50, file="games/doom2/data/boss2/icon2.wad", map="MAP30" },
    { prob=50, file="games/doom2/data/boss2/icon3.wad", map="MAP01" },
    { prob=50, file="games/doom2/data/boss2/icon3.wad", map="MAP02" },
    { prob=50, file="games/doom2/data/boss2/icon3.wad", map="MAP03" }
  }
}
