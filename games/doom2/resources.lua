...
function DOOM2.make_cool_gfx()
  ...
  local colmaps =
  {
    ...
    DOOM2.LEVEL_GFX_COLORS.gold,
    DOOM2.LEVEL_GFX_COLORS.silver,
    DOOM2.LEVEL_GFX_COLORS.iron,
  }
  ...
  gui.set_colormap(4, DOOM2.LEVEL_GFX_COLORS.iron)
  gui.set_colormap(5, DOOM2.LEVEL_GFX_COLORS.black)
...
function DOOM2.make_level_gfx(LEVEL)
  -- decide color set
  if not GAME.level_gfx_colors then
    ...
    GAME.level_gfx_colors = assert(DOOM2.LEVEL_GFX_COLORS[kind])
  end
...
function DOOM2.end_level(LEVEL)
  DOOM2.make_level_gfx(LEVEL)
end


function DOOM2.all_done()
  DOOM2.make_cool_gfx()
  DOOM2.make_episode_gfx()
