CHEX3.ENTITIES =
{
  ...
  generic_barrel = { id=11000, rid=2035, r=20, h=32 },
  generic_ceiling_light = { id=11001, rid=46, r=32, h=16, light=255, pass=true, ceil=true, add_mode="island" },
  generic_standalone_light = { id=11002, rid=35, r=32, h=16, light=255 }, -- "torches" and such, freestanding on a floor
  generic_wall_light    = { id=11003, rid=34, r=40, h=16, light=255, pass=true, add_mode="extend" }, -- "torches" and such, attached to a wall
  generic_wide_light    = { id=11004, rid=2028, r=32, h=16, light=255 }, -- wide standalone light, braziers, etc
  generic_small_pillar  = { id=11005, rid=32, r=32, h=20 },
