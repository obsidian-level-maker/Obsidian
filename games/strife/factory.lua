...
STRIFE.FACTORY.DM_SECTOR_TYPES =
{
  secret = { kind=9 },
...
STRIFE.FACTORY.DM_SCENERY_PREFABS =
{
  pillar_COMPWERD =
  {
...
STRIFE.FACTORY.DM_FEATURE_PREFABS =
{
...
STRIFE.FACTORY.DM_WALL_PREFABS =
{
  solid_CEMENT4 =
  {
...
STRIFE.FACTORY.DM_ARCH_PREFABS =
{
  arch_fence =
  {
    prefab = "ARCH_FENCE",
...
STRIFE.FACTORY.DM_DOOR_PREFABS =
{
  backup_plan =
  {
...
STRIFE.FACTORY.DM_WINDOW_PREFABS =
{
  window_narrow =
  {
...
STRIFE.FACTORY.DM_MISC_PREFABS =
{
  pedestal_PLAYER =
  {
    prefab = "PEDESTAL",
...
STRIFE.FACTORY.DM_DEATHMATCH_EXITS =
{
...
STRIFE.FACTORY.DM_QUEST_LEN_PROBS =
{
  ----------  2   3   4   5   6   7   8  9  10  -------
...
STRIFE.FACTORY.DM_MONSTER_GIVE =
{
...
STRIFE.FACTORY.DM_MONSTER_WEAPON_PREFS =
{
  zombie  = { shotty=6.0 },
  shooter = { shotty=6.0 },
  imp     = { shotty=6.0 },
...
STRIFE.FACTORY.DM_INITIAL_MODEL =
{
  doomguy =
  {
...
STRIFE.FACTORY.D2_FEATURE_PREFABS =
{
  overhang3_METAL6 =
  {
    prefab = "OVERHANG_3",
...
STRIFE.FACTORY.D2_WALL_PREFABS =
{
  solid_STUCCO2 =
  {
...
STRIFE.FACTORY.D2_DOOR_PREFABS =
{
  spacey =
  {
...
STRIFE.FACTORY.D2_MISC_PREFABS =
{
  fence_wire_STD =
  {
    prefab = "FENCE_RAIL",
...
STRIFE.FACTORY.D2_THEMES =
{
}

------------------------------------------------------------

STRIFE.FACTORY.D2_QUESTS =
{
  key =
  {
...
STRIFE.FACTORY.D2_EPISODE_THEMES =
{
...
STRIFE.FACTORY.D2_SECRET_KINDS =
{
  MAP31 = "wolfy",
  MAP32 = "wolfy",
}

STRIFE.FACTORY.D2_SECRET_EXITS =
{
  MAP15 = true,
  MAP31 = true,
}

STRIFE.FACTORY.D2_LEVEL_BOSSES =
{
  MAP07 = "mancubus",
  MAP20 = "spider",
  MAP30 = "boss_brain",
...
STRIFE.FACTORY.D2_EPISODE_INFO =
{
  { start=1,  len=11 },
...
function STRIFE.get_factory_levels(episode)

  assert(GAME.FACTORY.sky_info)

  local level_list = {}

  local theme_probs = STRIFE.FACTORY.D2_EPISODE_THEMES[episode]
  if OB_CONFIG.length ~= "full" then
    theme_probs = STRIFE.FACTORY.D2_EPISODE_THEMES[4]
  end
  assert(theme_probs)

  local ep_start  = STRIFE.FACTORY.D2_EPISODE_INFO[episode].start
  local ep_length = STRIFE.FACTORY.D2_EPISODE_INFO[episode].len
  ...
  for map = 1,ep_length do
    ...
    if episode == 2 and map >= 10 then
      ...
      Level.sky_info = STRIFE.FACTORY.D2_SKY_INFO[3]
      Level.theme_probs = { WOLF=10 }
      Level.toughness_factor = 1.2
    end

---!!! Level.boss_kind   = STRIFE.FACTORY.D2_LEVEL_BOSSES[Level.name]
    Level.secret_kind = STRIFE.FACTORY.D2_SECRET_KINDS[Level.name]
    Level.secret_exit = STRIFE.FACTORY.D2_SECRET_EXITS[Level.name]

    std_decide_quests(Level, STRIFE.FACTORY.D2_QUESTS, STRIFE.FACTORY.DM_QUEST_LEN_PROBS)
...
function STRIFE.factory_setup()
  ...
  GAME.FACTORY = 
  {
    ...
    monsters = STRIFE.FACTORY.DM_MONSTERS,
    bosses   = STRIFE.FACTORY.DM_BOSSES,
    weapons  = STRIFE.FACTORY.DM_WEAPONS,

    things = STRIFE.FACTORY.DM_THINGS,

    mon_give       = STRIFE.FACTORY.DM_MONSTER_GIVE,
    mon_weap_prefs = STRIFE.FACTORY.DM_MONSTER_WEAPON_PREFS,
    initial_model  = STRIFE.FACTORY.DM_INITIAL_MODEL,

    pickups = STRIFE.FACTORY.DM_PICKUPS,
    pickup_stats = { "health", "bullet", "shell", "rocket", "cell" },
    niceness = STRIFE.FACTORY.DM_NICENESS,

    dm = STRIFE.FACTORY.DM_DEATHMATCH,
    dm_exits = STRIFE.FACTORY.DM_DEATHMATCH_EXITS,

    combos    = STRIFE.FACTORY.DM_COMBOS,
    exits     = STRIFE.FACTORY.DM_EXITS,
    hallways  = STRIFE.FACTORY.DM_HALLWAYS,

    hangs     = STRIFE.FACTORY.DM_OVERHANGS,
    pedestals = STRIFE.FACTORY.DM_PEDESTALS,
    mats      = STRIFE.FACTORY.DM_MATS,
    crates    = STRIFE.FACTORY.DM_CRATES,

    liquids   = STRIFE.FACTORY.DM_LIQUIDS,
    switches  = STRIFE.FACTORY.DM_SWITCHES,
    doors     = STRIFE.FACTORY.DM_DOORS,
    key_doors = STRIFE.FACTORY.DM_KEY_DOORS,
    lifts     = STRIFE.FACTORY.DM_LIFTS,

    images    = STRIFE.FACTORY.DM_IMAGES,
    lights    = STRIFE.FACTORY.DM_LIGHTS,

    rooms     = STRIFE.FACTORY.DM_ROOMS,
    themes    = STRIFE.FACTORY.DM_THEMES,

    sc_fabs   = STRIFE.FACTORY.DM_SCENERY_PREFABS,
    feat_fabs = STRIFE.FACTORY.DM_FEATURE_PREFABS,
    wall_fabs = STRIFE.FACTORY.DM_WALL_PREFABS,

    door_fabs = STRIFE.FACTORY.DM_DOOR_PREFABS,
    arch_fabs = STRIFE.FACTORY.DM_ARCH_PREFABS,
    win_fabs  = STRIFE.FACTORY.DM_WINDOW_PREFABS,
    misc_fabs = STRIFE.FACTORY.DM_MISC_PREFABS,
  ...
  GAME.FACTORY.level_func = STRIFE.get_factory_levels

  GAME.FACTORY.quests   = STRIFE.FACTORY.D2_QUESTS
  GAME.FACTORY.sky_info = STRIFE.FACTORY.D2_SKY_INFO

  GAME.FACTORY.themes   = table.merge_w_copy(GAME.FACTORY.themes,   STRIFE.FACTORY.D2_THEMES)
  GAME.FACTORY.rooms    = table.merge_w_copy(GAME.FACTORY.rooms,    STRIFE.FACTORY.D2_ROOMS)
  GAME.FACTORY.monsters = table.merge_w_copy(GAME.FACTORY.monsters, STRIFE.FACTORY.D2_MONSTERS)

  GAME.FACTORY.combos   = table.merge_w_copy(GAME.FACTORY.combos,   STRIFE.FACTORY.D2_COMBOS)
  GAME.FACTORY.hallways = table.merge_w_copy(GAME.FACTORY.hallways, STRIFE.FACTORY.D2_HALLWAYS)
  GAME.FACTORY.exits    = table.merge_w_copy(GAME.FACTORY.exits,    STRIFE.FACTORY.D2_EXITS)

  GAME.FACTORY.rails = STRIFE.FACTORY.D2_RAILS

  GAME.FACTORY.hangs   = table.merge_w_copy(GAME.FACTORY.hangs,   STRIFE.FACTORY.D2_OVERHANGS)
  GAME.FACTORY.crates  = table.merge_w_copy(GAME.FACTORY.crates,  STRIFE.FACTORY.D2_CRATES)
  GAME.FACTORY.mats    = table.merge_w_copy(GAME.FACTORY.mats,    STRIFE.FACTORY.D2_MATS)
  GAME.FACTORY.doors   = table.merge_w_copy(GAME.FACTORY.doors,   STRIFE.FACTORY.D2_DOORS)
  GAME.FACTORY.lights  = table.merge_w_copy(GAME.FACTORY.lights,  STRIFE.FACTORY.D2_LIGHTS)
  GAME.FACTORY.liquids = table.merge_w_copy(GAME.FACTORY.liquids, STRIFE.FACTORY.D2_LIQUIDS)

  GAME.FACTORY.sc_fabs   = table.merge_w_copy(GAME.FACTORY.sc_fabs,   STRIFE.FACTORY.D2_SCENERY_PREFABS)
  GAME.FACTORY.feat_fabs = table.merge_w_copy(GAME.FACTORY.feat_fabs, STRIFE.FACTORY.D2_FEATURE_PREFABS)
  GAME.FACTORY.wall_fabs = table.merge_w_copy(GAME.FACTORY.wall_fabs, STRIFE.FACTORY.D2_WALL_PREFABS)
  GAME.FACTORY.door_fabs = table.merge_w_copy(GAME.FACTORY.door_fabs, STRIFE.FACTORY.D2_DOOR_PREFABS)
  GAME.FACTORY.misc_fabs = table.merge_w_copy(GAME.FACTORY.misc_fabs, STRIFE.FACTORY.D2_MISC_PREFABS)
  ...
  GAME.FACTORY.PREFABS = STRIFE.FACTORY.PREFABS
