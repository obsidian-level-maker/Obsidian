...
HARMONY.FACTORY.DM_SECTOR_TYPES =
{
  secret = { kind=9 },
...
HARMONY.FACTORY.DM_SCENERY_PREFABS =
{
  pillar_COMPWERD =
  {
...
HARMONY.FACTORY.DM_FEATURE_PREFABS =
{
...
HARMONY.FACTORY.DM_WALL_PREFABS =
{
  solid_CEMENT4 =
  {
...
HARMONY.FACTORY.DM_ARCH_PREFABS =
{
  arch_fence =
  {
    prefab = "ARCH_FENCE",
...
HARMONY.FACTORY.DM_DOOR_PREFABS =
{
  backup_plan =
  {
...
HARMONY.FACTORY.DM_WINDOW_PREFABS =
{
  window_narrow =
  {
...
HARMONY.FACTORY.DM_MISC_PREFABS =
{
  pedestal_PLAYER =
  {
    prefab = "PEDESTAL",
...
HARMONY.FACTORY.DM_DEATHMATCH_EXITS =
{
...
HARMONY.FACTORY.DM_QUEST_LEN_PROBS =
{
  ----------  2   3   4   5   6   7   8  9  10  -------
...
HARMONY.FACTORY.DM_MONSTER_GIVE =
{
...
HARMONY.FACTORY.DM_MONSTER_WEAPON_PREFS =
{
  zombie  = { shotty=6.0 },
  shooter = { shotty=6.0 },
  imp     = { shotty=6.0 },
...
HARMONY.FACTORY.DM_INITIAL_MODEL =
{
  doomguy =
  {
...
HARMONY.FACTORY.D2_FEATURE_PREFABS =
{
  overhang3_METAL6 =
  {
    prefab = "OVERHANG_3",
...
HARMONY.FACTORY.D2_WALL_PREFABS =
{
  solid_STUCCO2 =
  {
...
HARMONY.FACTORY.D2_DOOR_PREFABS =
{
  spacey =
  {
...
HARMONY.FACTORY.D2_MISC_PREFABS =
{
  fence_wire_STD =
  {
    prefab = "FENCE_RAIL",
...
HARMONY.FACTORY.D2_THEMES =
{
}

------------------------------------------------------------

HARMONY.FACTORY.D2_QUESTS =
{
  key =
  {
...
HARMONY.FACTORY.D2_EPISODE_THEMES =
{
...
HARMONY.FACTORY.D2_SECRET_KINDS =
{
  MAP31 = "wolfy",
  MAP32 = "wolfy",
}

HARMONY.FACTORY.D2_SECRET_EXITS =
{
  MAP15 = true,
  MAP31 = true,
}

HARMONY.FACTORY.D2_LEVEL_BOSSES =
{
  MAP07 = "mancubus",
  MAP20 = "spider",
  MAP30 = "boss_brain",
...
HARMONY.FACTORY.D2_EPISODE_INFO =
{
  { start=1,  len=11 },
...
function HARMONY.get_factory_levels(episode)

  assert(GAME.FACTORY.sky_info)

  local level_list = {}

  local theme_probs = HARMONY.FACTORY.D2_EPISODE_THEMES[episode]
  if OB_CONFIG.length ~= "full" then
    theme_probs = HARMONY.FACTORY.D2_EPISODE_THEMES[4]
  end
  assert(theme_probs)

  local ep_start  = HARMONY.FACTORY.D2_EPISODE_INFO[episode].start
  local ep_length = HARMONY.FACTORY.D2_EPISODE_INFO[episode].len
  ...
  for map = 1,ep_length do
    ...
    if episode == 2 and map >= 10 then
      ...
      Level.sky_info = HARMONY.FACTORY.D2_SKY_INFO[3]
      Level.theme_probs = { WOLF=10 }
      Level.toughness_factor = 1.2
    end

---!!! Level.boss_kind   = HARMONY.FACTORY.D2_LEVEL_BOSSES[Level.name]
    Level.secret_kind = HARMONY.FACTORY.D2_SECRET_KINDS[Level.name]
    Level.secret_exit = HARMONY.FACTORY.D2_SECRET_EXITS[Level.name]

    std_decide_quests(Level, HARMONY.FACTORY.D2_QUESTS, HARMONY.FACTORY.DM_QUEST_LEN_PROBS)
...
function HARMONY.factory_setup()
  ...
  GAME.FACTORY = 
  {
    ...
    monsters = HARMONY.FACTORY.DM_MONSTERS,
    bosses   = HARMONY.FACTORY.DM_BOSSES,
    weapons  = HARMONY.FACTORY.DM_WEAPONS,

    things = HARMONY.FACTORY.DM_THINGS,

    mon_give       = HARMONY.FACTORY.DM_MONSTER_GIVE,
    mon_weap_prefs = HARMONY.FACTORY.DM_MONSTER_WEAPON_PREFS,
    initial_model  = HARMONY.FACTORY.DM_INITIAL_MODEL,

    pickups = HARMONY.FACTORY.DM_PICKUPS,
    pickup_stats = { "health", "bullet", "shell", "rocket", "cell" },
    niceness = HARMONY.FACTORY.DM_NICENESS,

    dm = HARMONY.FACTORY.DM_DEATHMATCH,
    dm_exits = HARMONY.FACTORY.DM_DEATHMATCH_EXITS,

    combos    = HARMONY.FACTORY.DM_COMBOS,
    exits     = HARMONY.FACTORY.DM_EXITS,
    hallways  = HARMONY.FACTORY.DM_HALLWAYS,

    hangs     = HARMONY.FACTORY.DM_OVERHANGS,
    pedestals = HARMONY.FACTORY.DM_PEDESTALS,
    mats      = HARMONY.FACTORY.DM_MATS,
    crates    = HARMONY.FACTORY.DM_CRATES,

    liquids   = HARMONY.FACTORY.DM_LIQUIDS,
    switches  = HARMONY.FACTORY.DM_SWITCHES,
    doors     = HARMONY.FACTORY.DM_DOORS,
    key_doors = HARMONY.FACTORY.DM_KEY_DOORS,
    lifts     = HARMONY.FACTORY.DM_LIFTS,

    images    = HARMONY.FACTORY.DM_IMAGES,
    lights    = HARMONY.FACTORY.DM_LIGHTS,

    rooms     = HARMONY.FACTORY.DM_ROOMS,
    themes    = HARMONY.FACTORY.DM_THEMES,

    sc_fabs   = HARMONY.FACTORY.DM_SCENERY_PREFABS,
    feat_fabs = HARMONY.FACTORY.DM_FEATURE_PREFABS,
    wall_fabs = HARMONY.FACTORY.DM_WALL_PREFABS,

    door_fabs = HARMONY.FACTORY.DM_DOOR_PREFABS,
    arch_fabs = HARMONY.FACTORY.DM_ARCH_PREFABS,
    win_fabs  = HARMONY.FACTORY.DM_WINDOW_PREFABS,
    misc_fabs = HARMONY.FACTORY.DM_MISC_PREFABS,
  ...
  GAME.FACTORY.level_func = HARMONY.get_factory_levels

  GAME.FACTORY.quests   = HARMONY.FACTORY.D2_QUESTS
  GAME.FACTORY.sky_info = HARMONY.FACTORY.D2_SKY_INFO

  GAME.FACTORY.themes   = table.merge_w_copy(GAME.FACTORY.themes,   HARMONY.FACTORY.D2_THEMES)
  GAME.FACTORY.rooms    = table.merge_w_copy(GAME.FACTORY.rooms,    HARMONY.FACTORY.D2_ROOMS)
  GAME.FACTORY.monsters = table.merge_w_copy(GAME.FACTORY.monsters, HARMONY.FACTORY.D2_MONSTERS)

  GAME.FACTORY.combos   = table.merge_w_copy(GAME.FACTORY.combos,   HARMONY.FACTORY.D2_COMBOS)
  GAME.FACTORY.hallways = table.merge_w_copy(GAME.FACTORY.hallways, HARMONY.FACTORY.D2_HALLWAYS)
  GAME.FACTORY.exits    = table.merge_w_copy(GAME.FACTORY.exits,    HARMONY.FACTORY.D2_EXITS)

  GAME.FACTORY.rails = HARMONY.FACTORY.D2_RAILS

  GAME.FACTORY.hangs   = table.merge_w_copy(GAME.FACTORY.hangs,   HARMONY.FACTORY.D2_OVERHANGS)
  GAME.FACTORY.crates  = table.merge_w_copy(GAME.FACTORY.crates,  HARMONY.FACTORY.D2_CRATES)
  GAME.FACTORY.mats    = table.merge_w_copy(GAME.FACTORY.mats,    HARMONY.FACTORY.D2_MATS)
  GAME.FACTORY.doors   = table.merge_w_copy(GAME.FACTORY.doors,   HARMONY.FACTORY.D2_DOORS)
  GAME.FACTORY.lights  = table.merge_w_copy(GAME.FACTORY.lights,  HARMONY.FACTORY.D2_LIGHTS)
  GAME.FACTORY.liquids = table.merge_w_copy(GAME.FACTORY.liquids, HARMONY.FACTORY.D2_LIQUIDS)

  GAME.FACTORY.sc_fabs   = table.merge_w_copy(GAME.FACTORY.sc_fabs,   HARMONY.FACTORY.D2_SCENERY_PREFABS)
  GAME.FACTORY.feat_fabs = table.merge_w_copy(GAME.FACTORY.feat_fabs, HARMONY.FACTORY.D2_FEATURE_PREFABS)
  GAME.FACTORY.wall_fabs = table.merge_w_copy(GAME.FACTORY.wall_fabs, HARMONY.FACTORY.D2_WALL_PREFABS)
  GAME.FACTORY.door_fabs = table.merge_w_copy(GAME.FACTORY.door_fabs, HARMONY.FACTORY.D2_DOOR_PREFABS)
  GAME.FACTORY.misc_fabs = table.merge_w_copy(GAME.FACTORY.misc_fabs, HARMONY.FACTORY.D2_MISC_PREFABS)
  ...
  GAME.FACTORY.PREFABS = HARMONY.FACTORY.PREFABS
