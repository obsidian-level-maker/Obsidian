----------------------------------------------------------------
-- GAME DEF : Blake Stone: Aliens of Gold
----------------------------------------------------------------
--
...
-- constants
BLAKE.FACTORY.NO_TILE = 0
BLAKE.FACTORY.NO_OBJ  = 0

BLAKE.FACTORY.PREFABS =
{
...
BLAKE.FACTORY.THINGS =
{
  ...
  -- enemies
  sector_patrol     = { kind="monster", r=30, h=60,
              id={ easy=138, medium=174, hard=210, dirs=true },
            },
  star_sentinel   = { kind="monster", r=30, h=60,
              id={ easy=108, medium=144, hard=180, dirs=true, patrol=4 },
            },
  star_trooper = { kind="monster", r=30, h=60,
              id={ easy=116, medium=152, hard=188, dirs=true, patrol=4 },
            },
  canister_alien = { kind="monster", r=30, h=60,
              id={ easy=126, medium=162, hard=198, dirs=true, patrol=4 },
            },
  mech_sentinel  = { kind="monster", r=30, h=60,
              id={ easy=216, medium=234, hard=252, dirs=true, patrol=4 },
            },
  mutant_human = { kind="monster", r=30, h=60,
            id={ easy=138, medium=174, hard=210, dirs=true },
          },
  fluid_alien = { kind="monster", r=30, h=60,
            id={ easy=108, medium=144, hard=180, dirs=true, patrol=4 },
          },
  plasma_alien = { kind="monster", r=30, h=60,
            id={ easy=116, medium=152, hard=188, dirs=true, patrol=4 },
          },
  genetic_guard = { kind="monster", r=30, h=60,
            id={ easy=126, medium=162, hard=198, dirs=true, patrol=4 },
          },
  mutated_guard  = { kind="monster", r=30, h=60,
            id={ easy=216, medium=234, hard=252, dirs=true, patrol=4 },
          },
  perscan_drone = { kind="monster", r=30, h=60,
          id={ easy=138, medium=174, hard=210, dirs=true },
        },
  plasma_sphere = { kind="monster", r=30, h=60,
          id={ easy=108, medium=144, hard=180, dirs=true, patrol=4 },
        },
  pod_alien = { kind="monster", r=30, h=60,
          id={ easy=116, medium=152, hard=188, dirs=true, patrol=4 },
        },
  turret = { kind="monster", r=30, h=60,
          id={ easy=126, medium=162, hard=198, dirs=true, patrol=4 },
        },

  -- bosses
  spider_mutant   = { kind="monster", id=232, r=30, h=60 },
  acid_dragon      = { kind="monster", id=268, r=30, h=60 },
  breather_beast = { kind="monster", id=233, r=30, h=60 },
  cyborg_warrior   = { kind="monster", id=250, r=30, h=60 },
  bio_mech       = { kind="monster", id=269, r=30, h=60 },
  reptillian    = { kind="monster", id=251, r=30, h=60 },

  -- pickups
  k_red = { kind="pickup", id=55, r=30, h=60, pass=true },
  k_yellow   = { kind="pickup", id=56, r=30, h=60, pass=true },
  k_green   = { kind="pickup", id=57, r=30, h=60, pass=true },
  k_blue   = { kind="pickup", id=58, r=30, h=60, pass=true },
  k_gold   = { kind="pickup", id=59, r=30, h=60, pass=true },

  first_aid = { kind="pickup", id=52, r=30, h=60, pass=true },

  energy_pack = { kind="pickup", id=49, r=30, h=60, pass=true },
  rapid_assault = { kind="pickup", id=50, r=30, h=60, pass=true },
  dual_disrupter = { kind="pickup", id=51, r=30, h=60, pass=true },

  -- scenery
  nothing     = { kind="scenery", id=0, r=30, h=60, pass=true },
...
BLAKE.FACTORY.ROOMS =
{
  ...
  SUPPLIES =
  {
    ...
    pickups = { first_aid=25, energy_pack=50 },
    pickup_rate = 66,
  },
...
BLAKE.FACTORY.MONSTERS =
{
  sector_patrol  = { prob=20, hp=1,   dm=5,  fp=1.0, melee=true, },
  star_sentinel  = { prob=60, hp=25,  dm=10, fp=1.0, hitscan=true, cage_fallback=10 },
  star_trooper   = { prob=30, hp=50,  dm=20, fp=1.7, hitscan=true, },
  canister_alien = { prob=10, hp=55,  dm=35, fp=1.9, hitscan=true, },
  mech_sentinel  = { prob=60, hp=100, dm=30, fp=1.4, hitscan=true, },
  mutant_human   = { prob=20, hp=1,   dm=5,  fp=1.0, melee=true, },
  fluid_alien    = { prob=60, hp=25,  dm=10, fp=1.0, hitscan=true, cage_fallback=10 },
  plasma_alien   = { prob=30, hp=50,  dm=20, fp=1.7, hitscan=true, },
  genetic_guard  = { prob=10, hp=55,  dm=35, fp=1.9, hitscan=true, },
  mutated_guard  = { prob=60, hp=100, dm=30, fp=1.4, hitscan=true, },
  perscan_drone  = { prob=60, hp=25,  dm=10, fp=1.0, hitscan=true, cage_fallback=10 },
  plasma_sphere  = { prob=30, hp=50,  dm=20, fp=1.7, hitscan=true, },
  pod_alien      = { prob=10, hp=55,  dm=35, fp=1.9, hitscan=true, },
  turret         = { prob=60, hp=100, dm=30, fp=1.4, hitscan=true, },
}

BLAKE.FACTORY.BOSSES =
{
  spider_mutant  = { hp=1000, dm=30, hitscan=true },
  acid_dragon    = { hp=1000, dm=30, hitscan=true },
  breather_beast = { hp=1000, dm=30, hitscan=true },
  cyborg_warrior = { hp=1000, dm=30, hitscan=true },
  bio_mech       = { hp=1000, dm=30, hitscan=true },
  reptillian     = { hp=1000, dm=30, hitscan=true },
}

BLAKE.FACTORY.MONSTER_GIVE =
{

}

BLAKE.FACTORY.WEAPONS =
{
  auto_pistol = { fp=0, melee=false,          rate=1.5, dm= 7, freq= 2, held=true },
  slow_protector = { fp=1, ammo="energy", per=1, rate=3.0, dm=17, freq=10, held=true },
  rapid_assault = { fp=2, ammo="energy", give=4, per=1, rate=8.0,  dm=17, freq=30, },
  dual_disrupter = { fp=3, ammo="energy", give=6, per=1, rate=16.0, dm=17, freq=90, },
  plasma_discharge = { fp=4, ammo="energy", give=6, per=1, rate=16.0, dm=17, freq=90, },
}

BLAKE.FACTORY.PICKUPS =
{
  first_aid = { stat="health", give=25 },
  energy_pack = { stat="energy", give=8 },
}

BLAKE.FACTORY.INITIAL_MODEL =
{
  blake =
  {
    health=100, armor=0, energy=8,
    auto_pistol=true, slow_protector=true
  }
}
...
function BLAKE.decide_quests(level_list, is_spear)

  local function add_quest(L, kind, item, secret_prob, ob_size)
    secret_prob = 0 --FIXME !!!!

    local len_probs = non_nil(BLAKE.FACTORY.QUEST_LEN_PROBS[kind])
    local Quest =
    {
      kind = kind,
      item = item,
  ...
  for zzz,Level in ipairs(level_list) do
    ...
    if rand.odds(90 - 40 * ((Level.ep_along-1) % 3)) then
      add_quest(Level, "weapon", "rapid_assault", 35, ob_size)
    end

    if gatling_maps[Level.ep_along] then
      add_quest(Level, "weapon", "dual_disrupter", 50, ob_size)
    end

    local keys = math.round(ob_size / 25)

    if keys >= 1 then
      add_quest(Level, "key", "k_red", 0, ob_size)
    end
    ...
    for i = 1,sel(is_spear,4,6) do
      if rand.odds(ob_size) then
        add_quest(Level, "item", "energy_pack", 50, ob_size)
      end
    end
...
function BLAKE.get_factory_levels(episode)

  local level_list = {}

  local theme_probs = BLAKE.FACTORY.EPISODE_THEMES[episode]

  local boss_kind = BLAKE.FACTORY.EPISODE_BOSSES[episode]
  if OB_CONFIG.length ~= "full" then
    boss_kind = BLAKE.FACTORY.EPISODE_BOSSES[rand.irange(1,6)]
  end
  ...
  for map = 0,10 do
    ...
    if BLAKE.FACTORY.SECRET_EXITS[Level.name] then
  ...
  local function dump_levels()
    for idx,L in ipairs(level_list) do
      gui.printf("Blake episode [%d] map [%d] : %s\n", episode, idx, L.name)
      show_quests(L.quests)
    end
  end

  BLAKE.decide_quests(level_list)
...
function BLAKE.factory_setup()
  ...
  GAME.FACTORY = 
  {
    ...
    TILE_NUMS = BLAKE.FACTORY.TILE_NUMS,
    NO_TILE = BLAKE.FACTORY.NO_TILE,
    NO_OBJ = BLAKE.FACTORY.NO_OBJ,

    ERROR_TEX  = BLAKE.FACTORY.NO_TILE,
    ERROR_FLAT = 99, -- dummy
    SKY_TEX    = 77, -- dummy

    episodes = 6,
    level_func = BLAKE.get_factory_levels,

    classes  = { "blake" },

    things     = BLAKE.FACTORY.THINGS,
    monsters   = BLAKE.FACTORY.MONSTERS,
    bosses     = BLAKE.FACTORY.BOSSES,
    mon_give   = BLAKE.FACTORY.MONSTER_GIVE,
    weapons    = BLAKE.FACTORY.WEAPONS,

    pickups = BLAKE.FACTORY.PICKUPS,
    pickup_stats = { "health", "energy" },

    initial_model = BLAKE.FACTORY.INITIAL_MODEL,

    quests  = BLAKE.FACTORY.QUESTS,

    dm = {},

    combos    = BLAKE.FACTORY.COMBOS,
    exits     = BLAKE.FACTORY.EXITS,
    hallways  = nil,

    doors     = BLAKE.FACTORY.DOORS,
    key_doors = BLAKE.FACTORY.KEY_DOORS,

    rooms     = BLAKE.FACTORY.ROOMS,
    themes    = BLAKE.FACTORY.THEMES,

    misc_fabs = BLAKE.FACTORY.MISC_PREFABS,
  ...
  GAME.FACTORY.PREFABS = BLAKE.FACTORY.PREFABS
