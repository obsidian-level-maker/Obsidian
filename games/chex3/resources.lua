...
function CHEX3.make_level_gfx(LEVEL)
  ...
  if not GAME.level_gfx_colors then
    ...
    GAME.level_gfx_colors = assert(CHEX3.LEVEL_GFX_COLORS[kind])
  end
...
function CHEX3.make_episode_gfx()
  -- this is for CHEX3 1 / Ultimate CHEX3.
  -- does nothing for CHEX3 2 / Final CHEX3 (they lack "name_patch" field).

  local colors = assert(CHEX3.LEVEL_GFX_COLORS["red"])
