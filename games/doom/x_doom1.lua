...
function ULTDOOM.nolimit_themes()
  if OB_CONFIG.port == "limit_removing" then
    ...
    GAME.THEMES.tech.beam_groups = { beam_shiny = 50, beam_textured = 50 }
    ...
    GAME.THEMES.tech.fence_posts = { Post_metal = 50 }
    GAME.THEMES.deimos.narrow_halls = { vent = 50 }
    GAME.THEMES.deimos.beam_groups = { beam_shiny = 50, beam_gothic = 50, beam_textured = 50 }
    ...
    GAME.THEMES.deimos.fence_posts = { Post_metal = 50 }
    GAME.THEMES.hell.narrow_halls = { vent = 50 }
    GAME.THEMES.hell.beam_groups = { beam_gothic = 50, beam_textured = 50 }
    ...
    GAME.THEMES.hell.fence_posts = { Post_metal = 50 }
    GAME.THEMES.flesh.narrow_halls = { vent = 50 }
    GAME.THEMES.flesh.beam_groups = { beam_gothic = 50, beam_wood = 50, beam_textured = 50 }
    ...
    GAME.THEMES.flesh.fence_posts = { Post_metal = 50 }
  end
end
