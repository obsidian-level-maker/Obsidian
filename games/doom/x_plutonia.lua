...
PLUTONIA.FACTORY.PL_WALL_PREFABS =
{
}

PLUTONIA.FACTORY.PL_LIQUIDS =
{
  water = { floor="FWATER1", wall="WFALL1" },
}

PLUTONIA.FACTORY.PL_SKY_INFO =
{
...
PLUTONIA.FACTORY.PL_MISC_PREFABS =
{
  pedestal_PLAYER =
  {
...
GAME_FACTORIES["plutonia"] = function()
  ...
  T.combos   = copy_and_merge(T.combos,   PLUTONIA.FACTORY.PL_COMBOS)
  T.hallways = copy_and_merge(T.hallways, PLUTONIA.FACTORY.PL_HALLWAYS)

  T.rails   = copy_and_merge(T.rails,   PLUTONIA.FACTORY.PL_RAILS)
  T.doors   = copy_and_merge(T.doors,   PLUTONIA.FACTORY.PL_DOORS)
  T.liquids = copy_and_merge(T.liquids, PLUTONIA.FACTORY.PL_LIQUIDS)

  T.misc_fabs = copy_and_merge(T.misc_fabs, PLUTONIA.FACTORY.PL_MISC_PREFABS)

  T.sky_info    = PLUTONIA.FACTORY.PL_SKY_INFO
  T.special_ped = PLUTONIA.FACTORY.PL_SPECIAL_PEDESTAL
