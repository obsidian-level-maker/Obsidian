...
function DOOM.themes_alts()
  if OB_CONFIG.port == "limit_removing" then
    ...
    GAME.THEMES.tech.beam_groups = { beam_textured = 50, beam_shiny = 50 }
    ...
    GAME.THEMES.urban.beam_groups = { beam_wood = 50, beam_textured = 50 }
    ...
    GAME.THEMES.urban.fence_posts = { Post_metal = 50 }
    GAME.THEMES.hell.narrow_halls = { vent = 50 }
    GAME.THEMES.hell.beam_groups = { beam_textured = 50, beam_gothic = 50 }
