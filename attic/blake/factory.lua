...
BLAKE.FACTORY.THINGS =
{
  ...
  -- Treat Bio Tech as scenery to not factor into pickups/fights
  bio_tech = { kind="scenery", id=24, r=30, h=60 },
...
BLAKE.FACTORY.PICKUPS =
{
  ...
  energy_pack = { stat="health", give=10 },
}
