/* Copyright 2000 David Chess; Copyright 2005-2007 Sam Trenholme; Copyright
 * 2021-2022 The OBSIDIAN Team
 *
...
config *get_config(std::filesystem::path filename)
{
    ...
    if (StringCaseCompareASCII(wadlength, "single") == 0)
    {
        answer->levelcount = 1;
    }
    else if (StringCaseCompareASCII(wadlength, "few") == 0)
    {
        answer->levelcount = 4;
    }
