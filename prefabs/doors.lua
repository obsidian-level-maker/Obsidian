...
PREFAB.DOOR =
{
  ...
  brushes =
  {
    ...
    -- door itself
    {
      { x = 160, y = 16, mat = "?door", kind = "?line_kind", peg=1, x_offset=0, y_offset=0 },
      { x = 160, y = 32, mat = "?door", kind = "?line_kind", peg=1, x_offset=0, y_offset=0 },
      { x =  32, y = 32, mat = "?door", kind = "?line_kind", peg=1, x_offset=0, y_offset=0 },
      { x =  32, y = 16, mat = "?door", kind = "?line_kind", peg=1, x_offset=0, y_offset=0 },
