...
PREFAB.MINI_DOOR1 =
{
  ...
  brushes =
  {
...

    {
      { x =  16, y = 168, mat = "?wall" }
      { x =  48, y = 136, mat = "?wall" }
      { x = 144, y = 136, mat = "?wall" }
      { x = 176, y = 168, mat = "?wall" }
...

    {
      { x =  40, y =  88, mat = "?door" }
      { x = 152, y =  88, mat = "?door" }
      { x = 152, y = 104, mat = "?door" }
      { x =  40, y = 104, mat = "?door" }
      { b = 24, delta_z=-16, mat = "?door", light_add=32 }
    }

    {
      { x = 144, y = 136, mat = "?wall" }
      { x = 160, y = 104, mat = "?wall" }
      { x = 176, y = 128, mat = "?wall" }
