...
class Music
{
  ...
  public:
    ...
    inline const Tones &tones() const
    {
        return _tones;
    }
    ...
    inline const std::vector<Chord> chord_progression() const
    {
        return _chord_progression;
    }
    inline size_t size() const
    {
        return _size;
    }
    inline size_t bars() const
    {
        return _size / get_bar_ticks();
    }
    inline size_t get_bar_ticks() const
    {
        return ticks_for(_signature->beat_value) * _signature->beats_per_bar;
    }
    inline NoteValue get_beat_value() const
    {
        return _signature->beat_value;
    }
    inline size_t parts() const
    {
        return _creators.size();
    }
    inline const std::vector<std::unique_ptr<Creator>> &creators() const
    {
        return _creators;
    }
    inline size_t tempo() const
    {
        return _tempo;
    }
    inline size_t tickTime() const
    {
        return 60000 / (_tempo * 32);
    }
    inline size_t duration() const
    {
        return (tickTime() * _size) / 1000;
    }
};
} // namespace steve
